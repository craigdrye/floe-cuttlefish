...
**Key concepts**: the major strategy families (long/short equity, event-driven/merger arbitrage, global macro, relative value, credit/distressed, quant/systematic) and what each is hunting; the multi-strategy / multi-manager "pod" platform (Citadel, Millennium, Point72) and how tight per-PM risk budgets, centralized financing, and pass-through fees changed the modern industry; gross exposure, net exposure, and leverage; alpha vs beta and factor exposure; the three classic edges (informational, analytical, behavioral) plus structural/regulatory edge; market efficiency and why mispricings persist (constraints, mandates, forced sellers); the mandate, risk limits, and benchmark; absolute return vs relative return.
...
**Key concepts**: driver-based modeling and isolating the swing factor; the valuation toolkit used to set a target (multiples vs peers and history, DCF, sum-of-the-parts) and why the multiple the market pays encodes its expectations; what is "priced in" and reverse-engineering the market's implied assumptions; upside/base/downside cases and honest probability weighting; expected value and the valuation gap between price and intrinsic value; risk-reward asymmetry (the convex setup: limited downside, larger upside); sensitivity analysis; decision triggers tied to model outputs; the difference between a wide range of outcomes (uncertainty) and a bad expected value.
...
## Research Notes
- Strategy taxonomy (long/short equity, event-driven/merger arb, global macro, relative value, credit/distressed, quant) and the alpha-vs-beta / factor-exposure framing reflect standard hedge-fund and investment-management references (CFA Institute curriculum on alternative investments, Pedersen's *Efficiently Inefficient*). The CFA Institute "Hedge Fund Strategies" reading groups these as equity-related, event-driven, relative value, opportunistic (macro/CTA), specialist, and multi-manager/multi-strategy — see https://www.cfainstitute.org/insights/professional-learning/refresher-readings/2026/hedge-funds-l1 . The multi-strategy / multi-manager "pod" platform (Citadel, Millennium, Point72) is added to Chapter 1 because it is the dominant structural form of the modern industry and was previously absent from the taxonomy.
...
- Regulatory touchpoints (accredited/qualified investors, SEC adviser registration, Form ADV/Form PF, 13F disclosure, MNPI/insider-trading lines) reflect the U.S. framework; specifics and thresholds should be confirmed against current SEC sources before teaching as settled detail, as rules and dollar thresholds are periodically updated. Verified current as of mid-2026: accredited-investor thresholds remain $1M net worth (excluding primary residence) or $200K/$300K income; qualified-purchaser thresholds remain $5M in investments (individuals) / $25M (entities) — https://carta.com/learn/private-funds/regulations/qualified-purchaser/ . The Form 13F reporting threshold remains $100M (the proposed raise to $3.5B was never adopted) — https://www.sec.gov/rules-regulations/staff-guidance/division-investment-management-frequently-asked-questions/frequently-asked-questions-about-form-13f . The Feb 2024 Form PF amendments for large hedge fund advisers had their compliance date extended to October 1, 2026 — https://www.sec.gov/rules-regulations/2025/09/s7-22-22 .
