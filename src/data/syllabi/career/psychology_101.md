# Psychology 101
*The greatest hits of the human mind: why we learn, remember, forget, conform, and feel.*

**ID**: `psychology101` · **Discipline**: Social Science · **Level**: Career

## Course Aim
Psychology is the science of why people do what they do, and it is full of stories you have probably half-heard: dogs drooling at a bell, volunteers flipping shock switches, a baby afraid of a white rat. This course gathers those famous studies and the big ideas behind them into one friendly tour, so the next time someone mentions Pavlov, Milgram, or the Big Five at dinner, you actually know what they mean.

The goal is not to turn you into a therapist or a researcher. It is to give a curious adult a solid, accurate mental map of the field: how learning works, how memory bends, why crowds freeze, how kids' minds grow, and what your brain is doing under the hood. We keep the language plain and the examples concrete, but we never dumb the science down into something false.
...
- **Core questions**: What did Pavlov's bell do before training? Why is Milgram's study remembered? What did Asch's lines reveal? What is the Stanford prison study cited for? What did Little Albert show?
- **Key concepts**: neutral stimulus, obedience to authority, normative conformity, power of social roles, conditioned emotion.
- **Common traps**: assuming the bell always caused salivation; thinking Milgram showed people resist orders; confusing Asch's peer pressure with Milgram's authority pressure.

## Chapter 2: Conditioning & Learning
- **Core questions**: How do classical and operant conditioning differ? Is removing a headache reinforcement or punishment? Why do slot machines hook people? How did Bobo-doll children learn aggression?
- **Key concepts**: classical vs operant conditioning, positive and negative reinforcement, punishment, variable-ratio schedules, observational learning.
- **Common traps**: treating "negative reinforcement" as punishment; thinking constant rewards build the strongest habits; assuming aggression must be directly rewarded to be learned.

## Chapter 3: Memory & Forgetting
- **Core questions**: What order do the memory stages run in? How many items fit in short-term memory? How did Loftus distort witness memory? What shape is the forgetting curve? What study habit wins?
...
- **Key concepts**: Piaget's stages (sensorimotor, preoperational, concrete, formal), conservation, Erikson's psychosocial stages, Ainsworth's attachment styles, contact comfort.
- **Common traps**: confusing object permanence with conservation; misordering Erikson's stages; assuming feeding, not comfort, drives attachment.

## Chapter 6: Social Psychology
- **Core questions**: Why does no one help in a crowd? Why do we call a bad driver a "jerk"? What did Festinger's $1 study show? What is groupthink? What is in-group bias?
- **Key concepts**: bystander effect and diffusion of responsibility, fundamental attribution error, cognitive dissonance, groupthink, in-group bias.
- **Common traps**: confusing the bystander effect with groupthink; mixing the fundamental attribution error with the self-serving bias; expecting bigger rewards to change attitudes more.

## Chapter 7: Personality
- **Core questions**: What are the Big Five? Which trait predicts performance? What is Freud's id? What sits at the base of Maslow's pyramid?
- **Key concepts**: OCEAN traits, conscientiousness as a predictor, Freud's id/ego/superego, Maslow's hierarchy of needs.
- **Common traps**: confusing the Big Five with Myers-Briggs or Freud; assuming extraversion predicts performance best; flipping Maslow's pyramid so self-actualization is at the base.

## Chapter 8: The Biological Brain
- **Core questions**: Which neuron part sends the signal onward? What crosses the synapse? Which structure handles fear? What did patient H.M. lose? What did Phineas Gage reveal?
- **Key concepts**: dendrite/cell body/axon/synapse, neurotransmitters, the amygdala, the hippocampus, the frontal lobe.
- **Common traps**: confusing dendrites with axons; mixing neurotransmitters with hormones; assuming the amygdala stores memory or the hippocampus handles fear.

## Chapter 9: Sensation, Perception, Motivation & Emotion
- **Core questions**: How do sensation and perception differ? What is the absolute threshold? Why do you stop feeling your clothes? What is intrinsic motivation? What does James-Lange say? Where is performance best on the arousal curve?
