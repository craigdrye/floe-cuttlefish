...
**Key concepts.** Portfolio risk — tracking error TE = σ(R_p − R_b), information ratio IR = α/TE; factor models (Fama-French, Carhart, Barra); risk budgeting and active share; Treynor-Black model for active management; performance attribution — Brinson allocation/selection/interaction, factor-based attribution; hedge fund risk — style drift, leverage, gates and side pockets, smoothed returns (Getmansky-Lo-Makarov unsmoothing), survivorship/backfill bias; private and illiquid assets — illiquidity premia, stale-mark/appraisal smoothing, private-credit and direct-lending risk (expanded materially in the 2026 curriculum, absorbing private-credit and Andrew Ang's illiquid-assets content); UCITS vs '40 Act vs Cayman master/feeder structures; stress testing investment portfolios — CCAR/DFAST principles applied buy-side; pension and insurance ALM.
...
**Key concepts.** The 2026 GARP current-issues set centres on six themes: artificial intelligence, private credit, geopolitical risk, rising government/sovereign debt, crypto and digital assets, and digital resilience. AI in finance — model risk for ML/LLM systems, explainability, fairness, third-party and cloud concentration, the FSB's systemic-vulnerability framing (common models/data driving correlated behaviour); private credit — the migration of leveraged lending off bank balance sheets into direct-lending and BDC structures, valuation opacity, leverage chains, and bank-to-nonbank linkages (a topic that crossed over from Current Issues into Investment Management for 2026); geopolitical risk and fragmentation — sovereign risk premia, equity drawdowns, emerging-market sensitivity (IMF GFSR scenario work); rising government debt and fiscal-monetary interactions (BIS Annual Economic Report); crypto-asset and tokenization risk — custody, smart contract, stablecoin runs (Terra/Luna), exchange failures (FTX), tokenization-driven market inefficiencies, regulating unbacked crypto; digital and operational resilience; climate risk — physical vs transition, scenario analysis (NGFS scenarios), stranded assets, supervisory climate stress tests (ECB, Bank of England). Legacy threads still worth knowing: the (now largely completed) IBOR transition to SOFR/€STR/SONIA with ISDA 2020 fallback language, and recent failures — Archegos, SVB/First Republic, Credit Suisse, Silvergate/Signature, LME nickel squeeze.

**Applied skills.** Build a transition-risk overlay on a credit book; critique an LLM application in credit decisioning under SR 11-7; trace the bank-to-nonbank linkages and valuation opacity in a private-credit exposure; reason about how a geopolitical shock propagates into sovereign spreads and EM funding.
...
- Private credit looks low-volatility largely because it is marked infrequently; stale marks understate true risk, much like smoothed hedge-fund returns.
- The current-issues list is refreshed annually; IBOR transition is now a legacy/maintenance topic rather than the live story it was in earlier cycles — verify the current GARP reading list before over-weighting it.

**Authoritative sources.** GARP Part II *Current Issues* readings (refresh each cycle — the 2026 set is a near-complete overhaul); FSB *Financial Stability Implications of Artificial Intelligence* (2024); IMF *Global Financial Stability Report* on geopolitical risk; BIS *Annual Economic Report*; NGFS climate scenarios; ISDA IBOR Fallbacks documentation.
...
## Research Notes
Authoritative sources consulted for this map (verify against the current GARP study guide each cycle — topic weights are stable but readings, especially Investment Management and Current Issues, change annually):
- https://www.garp.org/frm/program-exams — GARP official FRM exam structure: Part I = 100 MCQ / 4h, Part II = 80 MCQ / 4h, equally weighted.
- https://www.garp.org/frm/readings/required — GARP official required-readings list (source of truth for per-topic readings and renumbering).
- Part II topic weights (confirmed unchanged for 2026): Market Risk 20%, Credit Risk 20%, Operational Risk & Resilience 20%, Liquidity & Treasury 15%, Investment Management 15%, Current Issues 10%. Part I: Foundations 20%, Quantitative Analysis 20%, Financial Markets & Products 30%, Valuation & Risk Models 30% — verified via GARP and corroborating providers below.
- https://frm.midhafin.com/part-2/curriculum-changes-in-2026 — 2026 vs 2025 Part II changes: Investment Management expands ~55% (absorbs private credit from Current Issues and Andrew Ang's illiquid-assets material from Liquidity); Current Issues is a near-complete refresh; Operational Risk & Resilience unchanged; Market/Credit are LOS-wording-only.
- https://analystprep.com/blog/frm-curriculum-changes-2025-2026/ — corroborating breakdown of the 2025→2026 curriculum changes and topic naming ("Operational Risk and Resilience").
- 2026 Current Issues themes (AI, private credit, geopolitical risk, rising government debt, crypto/digital assets, digital resilience), grounded in: FSB *The Financial Stability Implications of Artificial Intelligence* (Nov 2024); IMF *Global Financial Stability Report* (Apr 2025, Ch.2) on geopolitical risk; IMF Fintech Note *Tokenization and Financial Market Inefficiencies* (Jan 2025); BIS *Annual Economic Report*.
