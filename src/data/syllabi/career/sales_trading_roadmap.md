...
- Reaching for an equity-style benchmark (arrival, VWAP) in a market that has no consolidated tape or NBBO — in OTC fixed income the "fair" reference is itself an estimate, which is exactly why best-execution reviews there are harder and more scrutinized.
...
**Key concepts**: material non-public information (MNPI), information barriers/Chinese walls, and the wall-crossing process; the line between "color" and MNPI; best execution as a duty, not a courtesy (FINRA Rule 5310's "regular and rigorous" review, MSRB G-18 for municipals, and why fixed income has no consolidated tape/NBBO to benchmark against the way equities do); market manipulation — spoofing and layering (made a felony by Dodd-Frank §747, up to $1m and 10 years per count), front-running, wash trades, marking the close, and the LIBOR/FX-fixing legacy that hardened the rules; suitability and fair dealing; restricted and watch lists; communications surveillance and recorded lines/chats; the European research-payment regime and its recent reversal (MiFID II forced research/execution unbundling from 2018; the EU Listing Act, in force December 2024, and the FCA's 2024 UK reforms now re-permit joint "bundled" payments, so unbundling is no longer the settled rule); the desk's relationship with compliance and when to escalate; how a single chat message becomes evidence.
...
**Key concepts**: electronification and the shift from voice to e-trading and RFQ platforms; spread compression and what it did to flow-desk economics; the rise of algorithmic and systematic market-making and the role of non-bank liquidity providers; balance-sheet and capital constraints since the post-2008 reforms (the cost of warehousing risk under modern capital rules, now codified for the trading book by the Fundamental Review of the Trading Book (FRTB) under Basel III/"Basel III endgame," phasing in across the EU, UK, and US from 2027 and materially raising market-risk capital); the split between flow and structured/exotic businesses; how desks are budgeted and how traders and salespeople are actually evaluated (P&L, client revenue, franchise value); the modern skill set — markets fluency plus data, coding, and platform literacy; the career ladder and exits.
...
- Conduct and compliance content reflects the U.S./global market-abuse framework: MNPI and information barriers, best-execution duties, manipulation (spoofing/layering, front-running, marking the close), the LIBOR and FX-fixing enforcement legacy, communications surveillance, and the European research-payment regime. Specific rule thresholds and the post-trade transparency regime are periodically updated and should be confirmed against current FINRA/SEC/FCA/ESMA sources before teaching as settled detail.
- Best-execution duty is anchored to FINRA Rule 5310 ("reasonable diligence," "regular and rigorous" review) and MSRB G-18 for municipals; the contrast that equities have a consolidated tape/NBBO while OTC fixed income does not is the key teaching point. Source: https://www.finra.org/rules-guidance/rulebooks/finra-rules/5310 and FINRA 2025 Annual Regulatory Oversight Report (Best Execution).
- Spoofing/layering as criminal conduct rests on Dodd-Frank §747 (Commodity Exchange Act §4c(a)(5)), which made spoofing a felony (up to $1m fine and 10 years' imprisonment per count); the Coscia case was the landmark criminal prosecution. Source: https://www.kslaw.com/attachments/000/007/109/original/Spoofing_US_Law_and_Enforcement.pdf.
- The LIBOR transition is materially complete: all USD LIBOR panel settings ceased 30 June 2023 and synthetic USD LIBOR ended 30 September 2024, with SOFR as the established USD reference rate; LIBOR now functions in this course as a conduct/benchmark-manipulation legacy, not a live rate. Source: https://www.newyorkfed.org/arrc/sofr-transition.
- CURRENCY NOTE — research unbundling has reversed. MiFID II forced research/execution unbundling from 2018, but the EU Listing Act (in force 4 December 2024) abolished the EUR 1bn threshold and re-permits joint payments, and the FCA introduced parallel UK reforms in 2024; "rebundling" is now the direction of travel, so unbundling should no longer be taught as the settled rule. Sources: https://www.pinsentmasons.com/out-law/news/fca-proposes-reversal-of-mifid-ii-research-unbundling-rules and ESMA Final Report ESMA35-335435667-6290 (8 April 2025).
- Electronification, spread compression, non-bank liquidity providers, and the post-2008 capital/balance-sheet cost of warehousing risk reflect documented changes in sell-side trading economics; desk evaluation on durable client revenue and risk-adjusted return on capital is standard industry practice. The trading-book capital framework is now codified by the Fundamental Review of the Trading Book (FRTB) under Basel III/"Basel III endgame," phasing in across the EU (1 Jan 2027), UK (1 Jan 2027; IMA deferred to 2028), and US (re-proposed March 2026), and is expected to raise market-risk capital materially. Sources: https://www.icmagroup.org/market-practice-and-regulatory-policy/secondary-markets/secondary-markets-regulation/fundamental-review-of-the-trading-book-frtb/ and https://www.isda.org/2026/03/30/next-steps-on-a-much-improved-basel-iii-endgame/.
