...
The spine of the course is the incident lifecycle that every serious team uses some version of: detect and triage, understand identity and access, investigate across endpoint, network, and cloud, contain and recover, then communicate and learn. We anchor the vocabulary to the frameworks practitioners cite — the NIST SP 800-61 incident lifecycle, MITRE ATT&CK tactics, CVSS severity, the IOC/IOA/TTP distinction — so the words point at something real rather than floating as buzzwords. Where a term is genuinely contested or vendor-flavored (XDR, MDR, "next-gen" anything), we say so.
...
- **Key concepts**: the NIST SP 800-61 incident lifecycle — the widely taught Rev 2 four-phase model (Preparation; Detection and Analysis; Containment, Eradication, and Recovery; Post-Incident Activity), now superseded by Rev 3 (April 2025), which reframes incident response around the CSF 2.0 functions Govern/Identify/Protect (prepare), Detect/Respond/Recover (handle), and continuous Improvement; isolate/block/revoke/rotate/patch; eradication vs. recovery; forensic preservation and order of volatility; rollback path and production risk; "short-term vs. long-term" containment.
...
## Research Notes
- NIST SP 800-61 Rev. 3 (final, April 2025), "Incident Response Recommendations and Considerations for Cybersecurity Risk Management: A CSF 2.0 Community Profile" — supersedes Rev. 2 and drops the rigid four-phase lifecycle in favor of mapping IR activities onto CSF 2.0 functions (Govern, Identify, Protect, Detect, Respond, Recover) plus continuous improvement: https://csrc.nist.gov/pubs/sp/800/61/r3/final
- Industrial Cyber summary of the Rev. 3 model structure (preparation / response / continuous improvement layering, supersession of Rev. 2): https://industrialcyber.co/nist/nist-publishes-sp-800-61-rev-3-overhauling-incident-response-guidance-for-csf-2-0/
- CVSS v4.0 specification (FIRST) — confirms qualitative severity bands None 0.0 / Low 0.1-3.9 / Medium 4.0-6.9 / High 7.0-8.9 / Critical 9.0-10.0: https://www.first.org/cvss/v4.0/specification-document
- MITRE ATT&CK Enterprise tactics — long-standing 14-tactic set (Reconnaissance through Impact); note v19 (April 2026) split Defense Evasion into Stealth and Defense Impairment, so cite a version when referencing the tactic count: https://attack.mitre.org/tactics/enterprise/
- David Bianco's Pyramid of Pain — confirms the bottom-to-top ordering Hash Values, IP Addresses, Domain Names, Network/Host Artifacts, Tools, TTPs: https://www.attackiq.com/glossary/pyramid-of-pain-2/
