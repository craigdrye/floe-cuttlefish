...
export type TrackSeed = {
  ...
  /** Jurisdictions this track is tailored to (e.g. ['US'], ['US', 'UK', 'EU']). Empty/undefined = jurisdiction-neutral. */
  regions?: string[]
  /** ISO date (YYYY-MM-DD) of last regulation/content review. Required for regulation-adjacent tracks. */
  lastReviewed?: string
}
