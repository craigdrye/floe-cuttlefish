...
export const algebra2ExamBatchQuestions = makeQuestionBank('Mathematics', [
  q(438001, 'Functions', 'Inverse function', 'If f(x) = 2x + 5, what is f inverse of x?', '(x - 5)/2', [
  ...
  q(438002, 'Function Composition', 'Compose functions', 'If f(x) = x + 3 and g(x) = 2x, what is f(g(4))?', '11', [
  ...
  q(438003, 'Complex Numbers', 'Powers of i', 'What is i^2?', '-1', [
  ...
  q(438004, 'Logarithms', 'Log definition', 'What is log_2(32)?', '5', [
  ...
  q(438005, 'Exponential Equations', 'Solve exponential equation', 'Solve 3^x = 81.', '4', [
  ...
  q(438006, 'Rational Expressions', 'Excluded value', 'For the expression 1/(x - 6), which value is excluded from the domain?', 'x = 6', [
  ...
  q(438007, 'Polynomials', 'Remainder theorem', 'For p(x) = x^3 - 2x + 1, what is the remainder when p(x) is divided by x - 2?', '5', [
  ...
  q(438008, 'Transformations', 'Vertical shift', 'Compared with y = x^2, what does y = x^2 - 7 do to the graph?', 'Shifts it down 7 units', [
  ...
  q(438009, 'Sequences and Series', 'Geometric sequence', 'A geometric sequence starts 3, 6, 12, 24, ... What is the common ratio?', '2', [
  ...
  q(438010, 'Probability', 'Independent events', 'If independent events A and B have P(A)=0.4 and P(B)=0.5, what is P(A and B)?', '0.20', [
