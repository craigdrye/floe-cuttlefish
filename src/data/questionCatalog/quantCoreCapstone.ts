...
export const quantCapstoneQuestions: Question[] = makeQuestionBank('Quant Finance', [
  ...
  },
  {
    ...
    wrong: [
      ...
      ['Bank the time for coding because multi-step EV calculations often turn into arithmetic traps.', 'Bailing on a problem Alex knows the algorithm for in favor of one that has not been started is loss-aversion masquerading as pacing discipline. The right move is to execute the EV efficiently, not to flee it.', 'Efficient execution beats avoidance.'],
    ],
