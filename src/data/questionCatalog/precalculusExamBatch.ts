...
export const precalculusExamBatchQuestions = makeQuestionBank('Mathematics', [
  q(439001, 'Trigonometry', 'Radians', 'What is 180 degrees in radians?', 'pi', [
  ...
  q(439002, 'Trigonometry', 'Pythagorean identity', 'Which identity is always true?', 'sin^2(x) + cos^2(x) = 1', [
  ...
  q(439003, 'Functions', 'Composition domain', 'If f(x) = sqrt(x) and g(x) = x - 4, what restriction is needed for f(g(x))?', 'x >= 4', [
  ...
  q(439004, 'Vectors', 'Dot product', 'What is the dot product of <2, -1> and <3, 4>?', '2', [
  ...
  q(439005, 'Conics', 'Ellipse form', 'Which equation represents an ellipse centered at the origin?', 'x^2/9 + y^2/4 = 1', [
  ...
  q(439006, 'Rational Functions', 'Vertical asymptote', 'For f(x) = (x + 1)/(x - 5), what is the vertical asymptote?', 'x = 5', [
  ...
  q(439007, 'Exponential and Logarithmic Functions', 'Log property', 'Simplify log_b(mn).', 'log_b(m) + log_b(n)', [
  ...
  q(439008, 'Polynomial Functions', 'End behavior', 'A polynomial has positive leading coefficient and odd degree. What is its end behavior?', 'Falls left, rises right', [
  ...
  q(439009, 'Sequences and Series', 'Finite geometric sum', 'What is the sum 1 + 2 + 4 + 8 + 16?', '31', [
  ...
  q(439010, 'Binomial Theorem', 'Binomial expansion coefficient', 'In the expansion of (x + 2)^3, what is the coefficient of x^2?', '6', [
