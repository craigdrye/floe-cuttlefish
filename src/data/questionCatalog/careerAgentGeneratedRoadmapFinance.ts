...
export const careerAgentGeneratedRoadmapFinanceQuestionsByTrack: Record<string, Question[]> = {
  ...
  ventureCapitalRoadmap: runPolish(tagDifficulty([
    ...
    q(4350006, 'Career Skills', 'Venture Model and Fund Math', 'Breaking the reserves ratio',
      ...
      [
        ...
        ['Skip the round and harvest the markup', 'Skipping the round gives up ownership defense and signals weak support to the next lead. The markup is paper either way.'],
      ],
    ...
    q(4350023, 'Career Skills', 'Venture Model and Fund Math', 'Concentration limit',
      ...
      [
        ...
        ['Ignore the limit because soft caps are advisory', 'Soft limits exist precisely so a partnership stops and considers concentration risk. Treating them as advisory defeats the purpose.'],
    ...
    q(4103001, 'Career Skills', 'Sourcing and Market Mapping', 'TAM cleanup',
      ...
      [
        ...
        ['Ignore market size because founders should never estimate it', 'Market size matters for fund-returner math — the issue is methodology, not whether to estimate at all.'],
      ],
    ...
    q(4105056, 'Career Skills', 'Sourcing and Market Mapping', 'Bottom-up TAM',
      ...
      [
        ...
        ['Ignore adoption because every clinic will definitely buy', '100% adoption is not realistic for any new software category — the question even gives you a 25% benchmark.'],
      ],
    ...
    q(4107312, 'Career Skills', 'Sourcing and Market Mapping', 'Regulated market path',
      ...
      [
        ...
        ['Assume regulators carve out exemptions for early-stage companies', 'Regulators apply rules uniformly across entrants. Startup status does not lower the licensing bar.'],
    ...
    q(4350107, 'Career Skills', 'Sourcing and Market Mapping', 'Adjacent markets',
      ...
      [
        ...
        ['Ignore adjacencies — only the entry market counts', 'For a venture-scale outcome, expansion math usually requires credible adjacencies. Ignoring them undersizes the opportunity.'],
    ...
    q(4350114, 'Career Skills', 'Sourcing and Market Mapping', 'Conference ROI',
      ...
      [
        ...
        ['Skip conferences entirely; they are all networking theater', 'Some conferences (founder-only events, vertical-specific gatherings) have real density. Blanket avoidance closes a real sourcing channel.'],
      ],
    ...
    q(4350115, 'Career Skills', 'Sourcing and Market Mapping', 'Event coverage strategy',
      ...
      [
        ['Skip prep and meet whoever you encounter naturally', 'Natural encounters at conferences are mostly low-signal. The high-yield meetings are the ones planned in advance with target founders.'],
    ...
    q(4350118, 'Career Skills', 'Sourcing and Market Mapping', 'Founder background diligence',
      ...
      [
        ...
        ['Ignore the background; only product matters', 'Background and product are both inputs. Ignoring background means missing founder-market fit signals that often decide outcomes.'],
      ],
    ...
    q(4350123, 'Career Skills', 'Sourcing and Market Mapping', 'Cost-curve catalyst',
      ...
      [
        ...
        ['Ignore costs because models will get cheaper anyway', 'Future cheapness is not a thesis. Today\'s economics determine whether the business actually works in the next 24 months.'],
      ],
    ...
    q(4350132, 'Career Skills', 'Sourcing and Market Mapping', 'Differentiation test',
      ...
      [
        ...
        ['Ignore differentiation — execution is all that matters', 'Execution matters, but without a real differentiator, execution alone rarely wins markets with many competitors.'],
    ...
    q(4350140, 'Career Skills', 'Sourcing and Market Mapping', 'Founder pre-meet reference',
      ...
      [
        ['Skip the meeting if the reference is negative', 'A single shallow reference is not enough to skip a meeting. References before meetings are usually surface-level.'],
    ...
    q(4350141, 'Career Skills', 'Sourcing and Market Mapping', 'Hot deal triage',
      ...
      [
        ['Skip diligence entirely and write the check on conviction', 'Diligence-skipping for speed is how funds make their worst investments. Some core checks (customer reality, key references) are non-negotiable.'],
    ...
    q(4105058, 'Career Skills', 'Startup Metrics and Diligence', 'Retention shape',
      ...
      [
        ['Assume churn is irrelevant because net retention is above 100%', '115% NRR can coexist with severe logo churn if a few large accounts expand fast — the headline hides the underlying churn.'],
    ...
    q(4350238, 'Career Skills', 'Startup Metrics and Diligence', 'Founder-curated cohort traps',
      ...
      [
        ...
        ['Skip the cohort analysis because three is a small sample', 'Cohort analysis is essential. The right move is to expand the sample, not to drop the analysis.'],
      ],
    ...
    q(4350316, 'Career Skills', 'Founder, Product, and Customer Evidence', 'Sourcing reference customers',
      ...
      [
        ...
        ['Skip reference calls because the founder will tip off their references', 'Tip-off risk is real but manageable with timing and independent sourcing. The reference signal is too valuable to skip.'],
      ],
    ...
    q(4350318, 'Career Skills', 'Founder, Product, and Customer Evidence', 'Customer-call plan under time pressure',
      ...
      [
        ['Pick the 5 largest customers because they have the most context', 'Size alone is a poor selector. The largest customers are usually the founder\'s most-prepared references, which gives you only one slice of signal.'],
    ...
    q(4350343, 'Career Skills', 'Founder, Product, and Customer Evidence', 'Founder + product + customer integration',
      ...
      [
        ...
        ['Skip because two of the four lenses are negative', 'Two negatives in a four-lens framework is not automatically disqualifying — many great companies have specific weaknesses to manage. The question is whether the weaknesses are addressable.'],
    ...
    q(4107785, 'Career Skills', 'Portfolio Support and Follow-On Decisions', 'Follow-on reserve choice',
      ...
      [
        ...
        ['Ignore reserves until every company is out of cash', 'Out-of-cash decisions happen under duress with no leverage. Reserve planning belongs earlier in the cycle.'],
      ],
    ...
    q(4350520, 'Career Skills', 'Portfolio Support and Follow-On Decisions', 'CEO support: recruiting',
      ...
      [
        ['Pick the candidate for the CEO based on the investor\'s judgment', 'Picking the hire usurps the CEO\'s call and creates accountability problems if the hire fails. The investor sources and filters; the CEO decides.'],
    ...
    q(4350538, 'Career Skills', 'Portfolio Support and Follow-On Decisions', 'Pay-to-play in a down round',
      ...
      [
        ...
        ['Ignore the round and hope for the best', 'Ignoring triggers automatic conversion to common. "Hope" is not a strategy when contractual triggers will execute regardless.'],
      ],
    ...
    q(4280102, 'Career Skills', 'Capstone: Investment Pack and Synthesis', 'Recommendation calibration',
      ...
      [
        ...
        ['Hard pass because logo retention is below 80%', 'A single weak metric does not kill a deal when the rest of the evidence is strong. The right move is a conditional yes with a specific test, not a categorical no.'],
  ...
  investmentBankingRoadmap: runPolish(tagDifficulty([
    ...
    q(4103008, 'Career Skills', 'Accounting and Financial Statement Links', 'Revenue bridge',
      ...
      [
        ...
        ['Use the client logo count as the revenue formula', 'Logo count is a vanity metric. Revenue depends on price per logo and contract value, which logo count alone does not capture.'],
      ],
    ...
    q(4103011, 'Career Skills', 'Valuation Core', 'DCF sanity',
      ...
      [
        ...
        ['Assume the DCF is perfect because it has many tabs', 'Tab count is not a quality indicator. A 92% terminal weighting is a structural concern regardless of model size.'],
    ...
    q(4105071, 'Career Skills', 'M&A and Capital Markets Materials', 'Synergy haircut',
      ...
      [
        ...
        ['Assume all synergies arrive before signing', 'Synergies are realized post-close, often over 2–3 years. Pulling them forward distorts the IRR and accretion math.'],
        ['Ignore synergies because buyers never model them', 'Synergies often justify the entire deal premium for strategic acquirers. Ignoring them misses the core thesis.'],
      ],
    ...
    q(4107796, 'Career Skills', 'M&A and Capital Markets Materials', 'Synergy multiple',
      ...
      [
        ...
        ['Assume all synergies close on day one', 'Synergies take 12–36 months to realize. Day-one assumption inflates accretion and IRR optics dishonestly.'],
        ['Ignore synergies because buyers never model them', 'Strategic buyers explicitly underwrite synergies. Ignoring them disconnects the model from the actual buying rationale.'],
      ],
    ...
    q(4107791, 'Career Skills', 'M&A and Capital Markets Materials', 'Management forecast drift',
      ...
      [
        ...
        ['Assume buyers prefer surprises after signing', 'Buyers who discover material changes post-signing pursue price adjustments or walk-away rights. Surprises destroy deals.'],
      ],
    ...
    q(4105074, 'Career Skills', 'Execution, Comments, and Quality Control', 'Footnote mismatch',
      ...
      [
        ...
        ['Delete the appendix without checking', 'Deleting the supporting work removes the audit trail. The summary number still needs to be verified, not abandoned.'],
    ...
    q(4340031, 'Career Skills', 'Execution, Comments, and Quality Control', 'Management presentation prep',
      ...
      [
        ...
        ['Skip rehearsals because over-coaching makes the CEO sound rehearsed', 'Under-prepared CEOs sound improvised and lose credibility on customer concentration, churn, or margin questions. Rehearsal builds confidence, not staginess.'],
      ],
  ...
  equityResearchRoadmap: runPolish(tagDifficulty([
    ...
    q(4103020, 'Career Skills', 'Company and Industry Setup', 'Channel check bias',
      ...
      [
        ...
        ['Ignore all channel checks forever', 'Channel checks are a core variant-perception tool when used carefully. Blanket dismissal forecloses the right kind of edge.'],
    ...
    q(4103021, 'Career Skills', 'Filings, Earnings, and Management Commentary', 'Guidance cut',
      ...
      [
        ['Assume the company permanently lost all demand', 'A one-quarter shift with intact backlog is the textbook definition of timing, not loss. Overreacting kills the thesis on noise.'],
        ['Ignore the cut because backlog always converts perfectly', 'Backlog conversion is conditional. The analyst should track the next quarter\'s actual conversion, not assume it.'],
    ...
    q(4105082, 'Career Skills', 'Filings, Earnings, and Management Commentary', 'Beat quality',
      ...
      [
        ...
        ['Ignore the tax rate because taxes are never recurring', 'Tax rate is highly recurring at a normalized level. The issue is that this quarter\'s rate was below the normal level.'],
    ...
    q(4107817, 'Career Skills', 'Filings, Earnings, and Management Commentary', 'Preannounce read',
      ...
      [
        ['Assume recovery because the sentence sounded nice', 'Management always frames preannouncements with forward optimism. The analyst job is to verify with independent evidence.'],
        ...
        ['Ignore the preannouncement until the annual report', 'Preannouncements move stocks immediately. Waiting for the 10-K means missing the actionable window.'],
      ],
    ...
    q(4103016, 'Career Skills', 'Forecasting and Model Discipline', 'Segment mix',
      ...
      [
        ...
        ['Ignore segment detail because only total sales matter', 'Segment detail is exactly what diagnoses earnings quality. Total sales is the headline, not the story.'],
        ['Assume wholesale growth always improves margins', 'Wholesale typically carries lower gross margins than direct in this business model. Mix shift compresses margins, not expands.'],
      ],
    ...
    q(4105076, 'Career Skills', 'Forecasting and Model Discipline', 'Inventory buildup',
      ...
      [
        ['Assume higher inventory always means higher future revenue', 'In a slowing market, rising inventory often signals overproduction, future markdowns, or obsolescence — not bullish demand.'],
        ['Ignore inventory because it is not on the income statement', 'Inventory builds become future COGS and write-downs that hit the income statement. Ignoring them misses the lag.'],
    ...
    q(4107814, 'Career Skills', 'Forecasting and Model Discipline', 'Pricing versus volume',
      ...
      [
        ['Assume price can rise forever', 'Price elasticity bites eventually. Repeated increases past a threshold accelerate volume loss faster than price compensates.'],
    ...
    q(4103018, 'Career Skills', 'Valuation and Rating Logic', 'Multiple discipline',
      ...
      [
        ...
        ['Ignore peer context because valuation is subjective', 'Peer context is what makes relative valuation possible. Ignoring comps means no anchor for the multiple.'],
      ],
    ...
    q(4107334, 'Career Skills', 'Valuation and Rating Logic', 'Sum-of-parts moment',
      ...
      [
        ...
        ['Ignore the hardware segment because it is less fashionable', 'Fashion is not analysis. A shrinking segment still generates cash and consumes capital; both matter.'],
      ],
    ...
    q(4107805, 'Career Skills', 'Valuation and Rating Logic', 'Terminal growth check',
      ...
      [
        ...
        ['Assume every company outgrows its market forever', 'No company outgrows its market in perpetuity. Terminal assumptions must respect mathematical limits.'],
      ],
    ...
    q(4107815, 'Career Skills', 'Valuation and Rating Logic', 'Scenario-weighted view',
      ...
      [
        ...
        ['Ignore refinancing because it is inconvenient', 'Refinancing is the single largest swing factor here. Ignoring it leaves no thesis.'],
      ],
    ...
    q(4107804, 'Career Skills', 'Valuation and Rating Logic', 'Rating after rerate',
      ...
      [
        ...
        ['Ignore valuation once the thesis feels familiar', 'Familiarity does not improve risk-reward. Rerating compresses forward returns regardless of how comfortable the position feels.'],
      ],
    ...
    q(4107813, 'Career Skills', 'Research Note and Investor Debate', 'Tone after downgrade',
      ...
      [
        ...
        ['Skip publication because the call was uncomfortable', 'Skipping publication after a downgrade leaves clients without ongoing coverage. The conclusion stands until evidence changes it.'],
  ...
  salesTradingRoadmap: runPolish(tagDifficulty([
    ...
    q(4103027, 'Career Skills', 'Client Flow and Trade Ideas', 'Hedge intent',
      ...
      [
        ...
        ['Ignore oil because airlines only move with passenger counts', 'Jet fuel is the second-largest cost line for airlines. Ignoring it misses a major driver of margins.'],
      ],
    ...
    q(4105090, 'Career Skills', 'Client Flow and Trade Ideas', 'Mandate-aware pitch',
      ...
      [
        ...
        ['Ignore the mandate because the client asked a question', 'Asking does not mean buying. A good salesperson uses the question to reaffirm what does fit.'],
    ...
    q(4107358, 'Career Skills', 'Client Flow and Trade Ideas', 'Best idea filter',
      ...
      [
        ...
        ['Ignore portfolio context because the trade is clever', 'Clever ideas in the wrong portfolio context can blow up the book. Context is the whole game.'],
      ],
    ...
    q(4107828, 'Career Skills', 'Client Flow and Trade Ideas', 'Cross-sell restraint',
      ...
      [
        ...
        ['Assume cash management secretly means leverage', 'Cash management means safety and liquidity, not leverage. Translating it otherwise is rationalization.'],
        ['Skip disclosures because the client is busy', 'Disclosures are required by rule. Client time pressure does not waive them.'],
      ],
    ...
    q(4103026, 'Career Skills', 'Execution, P&L, and Limits', 'Inventory shock',
      ...
      [
        ...
        ['Ignore the limit because client service is always exempt', 'Limits exist to protect the firm regardless of client size. No client transaction overrides risk policy.'],
      ],
    ...
    q(4107350, 'Career Skills', 'Execution, P&L, and Limits', 'Limit breach morning',
      ...
      [
        ...
        ['Assume client service cancels risk limits', 'No client trade exempts the desk from risk limits. Limits protect the firm, not the client.'],
      ],
    ...
    q(4200031, 'Career Skills', 'Regulation and Desk Communication', 'Restricted list mechanics',
      ...
      [
        ...
        ['Ignore the restriction since the trader has personal conviction', 'Personal conviction does not override restricted-list rules. The list exists precisely because conviction can mislead.'],
      ],
    ...
    q(4107833, 'Career Skills', 'Regulation and Desk Communication', 'Allocation fairness',
      ...
      [
        ['Reward whoever sent the funniest message', 'Allocation is regulated. Humor is not a permissible allocation factor.'],
  ...
  privateEquityRoadmap: runPolish(tagDifficulty([
    ...
    q(4103032, 'Career Skills', 'Business Diligence', 'Quality of earnings',
      ...
      [
        ...
        ['Ignore EBITDA and value only revenue', 'Revenue alone misses the entire profitability picture. EBITDA matters; the question is which EBITDA is sustainable.'],
        ['Assume all owner expenses continue forever without review', 'Some owner expenses (private jet, personal salaries) genuinely won\'t recur; others (real management compensation) absolutely will. The diligence determines which.'],
      ],
    ...
    q(4103033, 'Career Skills', 'Business Diligence', 'Customer concentration',
      ...
      [
        ['Ignore it because concentration makes reporting easier', 'Concentration is the largest single-name risk in the deal. Ignoring it means missing the deal-breaking exposure.'],
        ['Assume the customer will renew because revenue is historical', 'Historical revenue does not predict renewal. Contract structure, relationship depth, and switching costs do.'],
    ...
    q(4107364, 'Career Skills', 'Business Diligence', 'Key person risk',
      ...
      [
        ['Assume the founder will work forever', 'Founders sell because they want liquidity, often to retire. Assuming permanence ignores the obvious next move.'],
        ['Ignore relationships because EBITDA is historical', 'Historical EBITDA was generated by current relationships. Severing them changes future EBITDA.'],
    ...
    q(4107835, 'Career Skills', 'Business Diligence', 'Data room inconsistency',
      ...
      [
        ...
        ['Assume both numbers are close enough spiritually', '"Spiritually close" is not analytical. The actual number drives the model; both cannot be right.'],
    ...
    q(4107846, 'Career Skills', 'Business Diligence', 'Supplier fragility',
      ...
      [
        ['Assume supply chains enjoy being simple', 'Single-source supply chains are operational time bombs. COVID and shipping disruption made this risk concrete for every PE firm.'],
    ...
    q(4103036, 'Career Skills', 'Value Creation and Operating Plan', 'First 100 days',
      ...
      [
        ['Immediately redesign the logo before reviewing cash', 'Cash management is week-one priority. Branding is rarely a first-100-days lever.'],
    ...
    q(4105101, 'Career Skills', 'Value Creation and Operating Plan', 'Procurement savings',
      ...
      [
        ...
        ['Assume procurement has no EBITDA impact', 'Procurement savings flow directly to gross margin and EBITDA. They are one of the most direct synergies.'],
      ],
    ...
    q(4107378, 'Career Skills', 'Value Creation and Operating Plan', 'Working capital unlock',
      ...
      [
        ['Ignore working capital because EBITDA looks fine', 'Strong EBITDA with weak cash conversion is a classic warning. Cash, not EBITDA, services the debt.'],
    ...
    q(4107838, 'Career Skills', 'Value Creation and Operating Plan', 'Pricing leakage',
      ...
      [
        ...
        ['Ban all discounts without checking churn risk', 'Some discounts retain valuable customers. Blanket bans can destroy revenue faster than they improve margin.'],
        ['Assume list price equals realized price', 'List price is rarely realized price in B2B. Realization is the metric that matters.'],
      ],
    ...
    q(4103039, 'Career Skills', 'IC Memo, Deal Process, and Exit', 'Exit path',
      ...
      [
        ['Assume the market will always pay more later', 'Multiple expansion is not guaranteed. Many deals exit at the same or lower multiple than entry.'],
    ...
    q(4107371, 'Career Skills', 'IC Memo, Deal Process, and Exit', 'Exit buyer map',
      ...
      [
        ['Assume someone will want it eventually', 'Assumption-based exits leave the sponsor stuck holding the asset. Concrete buyer mapping is required.'],
        ...
        ['Ignore exit planning until year five', 'Year five is too late for exit planning. The exit thesis should be tested at IC, not at sale.'],
      ],
    ...
    q(4107849, 'Career Skills', 'IC Memo, Deal Process, and Exit', 'Diligence open item',
      ...
      [
        ...
        ['Assume legal issues enjoy resolving themselves', 'Legal issues require active resolution. They do not improve by being ignored.'],
  ...
  hedgeFundsRoadmap: runPolish(tagDifficulty([
    ...
    q(4103044, 'Career Skills', 'Modeling, Valuation, and Scenario Work', 'Mosaic discipline',
      ...
      [
        ...
        ['Ignore company filings because alternative data is newer', 'Filings remain the official record. Alternative data complements them, not replaces them.'],
      ],
    ...
    q(4103045, 'Career Skills', 'Modeling, Valuation, and Scenario Work', 'Thesis drift',
      ...
      [
        ...
        ['Ignore margin data until year-end', 'Margin data is the original thesis driver. Ignoring it means abandoning the analytical framework.'],
      ],
    ...
    q(4105110, 'Career Skills', 'Modeling, Valuation, and Scenario Work', 'Channel check conflict',
      ...
      [
        ['Choose the bullish signal because it is more fun', 'Cherry-picking is the opposite of mosaic discipline. The conflict itself is the signal to investigate.'],
    ...
    q(4107390, 'Career Skills', 'Modeling, Valuation, and Scenario Work', 'Segment hidden loss',
      ...
      [
        ...
        ['Ignore the growth segment because it is new', 'New segments are often where the equity value sits. Ignoring them misses the core thesis.'],
    ...
    q(4107854, 'Career Skills', 'Modeling, Valuation, and Scenario Work', 'Channel check sample',
      ...
      [
        ...
        ['Ignore weather because it complicates things', 'Weather is the obvious confounding variable here. Ignoring it means misreading local noise as company weakness.'],
    ...
    q(4105108, 'Career Skills', 'Shorts, Crowding, and Risk Control', 'Drawdown response',
      ...
      [
        ...
        ['Ignore the move because the original memo was long', 'The memo was written before the news. New information requires fresh analysis, not adherence to the original.'],
    ...
    q(4107382, 'Career Skills', 'Shorts, Crowding, and Risk Control', 'Stop versus thesis',
      ...
      [
        ['Ignore the stop because conviction feels noble', 'Stops exist to override conviction in losses. Ignoring them is how funds blow up.'],
        ['Exit without checking facts or process', 'Mechanical stops without analysis can exit good ideas at the worst time. Process matters.'],
    ...
    q(4107389, 'Career Skills', 'Shorts, Crowding, and Risk Control', 'Short borrow math',
      ...
      [
        ['Ignore borrow because it is paid later', '12% × 2 years = 24% of carrying cost, almost entirely offsetting the 25% expected downside. Borrow is the dominant variable.'],
        ['Assume the catalyst arrives next week', 'Timing assumptions should match evidence, not optimism. A two-year catalyst is a two-year cost.'],
    ...
    q(4200061, 'Career Skills', 'Portfolio Review and Performance Attribution', 'Contribution analysis',
      ...
      [
        ...
        ['Ignore contribution because total return is what matters', 'Total return tells you what happened; contribution tells you how reproducible it is. Process review needs contribution.'],
      ],
    ...
    q(4103046, 'Career Skills', 'Portfolio Review and Performance Attribution', 'Position sizing',
      ...
      [
        ...
        ['Ignore liquidity unless the market is closed', 'Liquidity determines whether you can exit. Ignoring it means accepting forced-hold risk.'],
      ],
    ...
    q(4107856, 'Career Skills', 'Portfolio Review and Performance Attribution', 'Net exposure creep',
      ...
      [
        ...
        ['Assume shorts will reappear when needed', 'Shorts require thesis development, borrow, and entry timing. They do not reappear on demand when net exposure overshoots.'],
      ],
  ...
  creditLevFinRoadmap: runPolish(tagDifficulty([
    ...
    q(4107396, 'Career Skills', 'Credit Metrics and Cash Flow', 'Lease-adjusted leverage',
      ...
      [
        ['Ignore leases because stores are pleasant', 'Operating leases are debt-like obligations under ASC 842 and are part of the fixed-charge burden whether on or off the funded-debt line.'],
        ['Treat lease expense as revenue', 'Lease expense is a cost, not revenue. Treating it as revenue inverts the income statement.'],
        ['Assume all leases can be canceled tomorrow', 'Most leases are long-dated and difficult to break. Treating them as cancelable optionality understates the contractual obligation.'],
      ],
    ...
    q(4107876, 'Career Skills', 'LevFin Markets and Debt Capacity', 'Rating agency adjustment',
      ...
      [
        ...
        ['Assume agencies love every adjustment', 'Agencies explicitly haircut aggressive add-backs (savings not yet realized, run-rate synergies). Their view is usually more conservative.'],
        ['Ignore ratings until after allocation', 'Ratings affect pricing and demand. Surprising the market with a worse rating after allocation breaks the deal.'],
      ],
    ...
    q(4107879, 'Career Skills', 'Covenants, Documentation, and Protection', 'EBITDA grower',
      ...
      [
        ['Assume all future savings arrive early', 'Hoping savings arrive early is not lender protection. Most never fully arrive at the projected pace.'],
        ...
        ['Ignore caps because EBITDA is adjusted', 'Caps are the primary protection against unbounded add-backs. Ignoring them defeats the structural protection.'],
      ],
    ...
    q(4107411, 'Career Skills', 'Distress Signals and Recovery Thinking', 'Make-whole dispute',
      ...
      [
        ...
        ['Assume contract disputes never affect value', 'Contract disputes routinely change recoveries by 10-30%. Document language is core to the analysis.'],
        ['Ignore legal advice because finance models are tidy', 'Distressed outcomes turn on legal interpretation as much as enterprise value. Both matter.'],
      ],
    ...
    q(4107877, 'Career Skills', 'Distress Signals and Recovery Thinking', 'Out-of-court option',
      ...
      [
        ['Pick the option with the shorter name', 'Out-of-court is shorter to say but can be longer to execute. The actual tradeoffs are economic.'],
        ['Assume court is always cleaner', 'Court is rarely "cleaner" — it adds public scrutiny, judicial process, and DIP financing requirements.'],
  ...
  bankComplianceAmlRoadmap: runPolish(tagDifficulty([
    ...
    q(4107412, 'Career Skills', 'KYC and Customer Risk', 'Address mismatch',
      ...
      [
        ['Pick the nicest address and move on', 'Address selection without documentation leaves an unexplained discrepancy in the file for the next reviewer.'],
        ...
        ['Ignore addresses because revenue is the goal', 'Revenue motivation does not override KYC requirements. CIP rules apply to every account.'],
      ],
    ...
    q(4107424, 'Career Skills', 'KYC and Customer Risk', 'PEP onboarding',
      ...
      [
        ...
        ['Ignore offshore entities if the customer is charming', 'Charm is not a risk control. Offshore entities require beneficial-ownership and source-of-funds work regardless.'],
      ],
    ...
    q(4107882, 'Career Skills', 'KYC and Customer Risk', 'Source of wealth gap',
      ...
      [
        ...
        ['Assume offshore structures explain themselves', 'Offshore structures require explicit documentation of why they exist and how the wealth was generated.'],
      ],
    ...
    q(4107894, 'Career Skills', 'KYC and Customer Risk', 'Nominee director clue',
      ...
      [
        ...
        ['Assume control does not matter if directors exist', 'Control is a separate concept from formal directorship. AML rules require identifying actual control, not titular roles.'],
    ...
    q(4107883, 'Career Skills', 'KYC and Customer Risk', 'Business purpose change',
      ...
      [
        ...
        ['Skip review if the customer sounds confident', 'Customer confidence is not evidence. New business purpose requires fresh underwriting.'],
      ],
    ...
    q(4107416, 'Career Skills', 'Sanctions and Screening', 'Name match triage',
      ...
      [
        ['Ignore partial matches forever', 'Some partial matches are real hits with intentionally misrepresented identifiers. Each needs investigation.'],
        ['Freeze the account without checking identifiers', 'Freezing every partial match disrupts legitimate customers and floods compliance with reversals.'],
    ...
    q(4107417, 'Career Skills', 'Sanctions and Screening', 'Vessel clue',
      ...
      [
        ...
        ['Assume shipping details are outside bank risk', 'Trade finance puts the bank squarely in the shipping chain. OFAC violations can result from vessel-based exposure.'],
      ],
    ...
    q(4107426, 'Career Skills', 'Sanctions and Screening', 'Country exposure',
      ...
      [
        ...
        ['Assume intermediary banks never matter', 'Intermediary banks are part of the payment. Their jurisdiction and ownership affect the bank\'s sanctions exposure.'],
    ...
    q(4107415, 'Career Skills', 'Transaction Monitoring and Alerts', 'Dormant account wakes',
      ...
      [
        ...
        ['Assume all international wires are suspicious without review', 'Many international flows are legitimate. Review is required, not preemptive judgment.'],
    ...
    q(4107425, 'Career Skills', 'Transaction Monitoring and Alerts', 'Crypto exchange flow',
      ...
      [
        ['Assume all crypto activity is automatically criminal', 'Crypto is widely used legitimately. The diligence is fit to profile, not blanket suspicion.'],
        ['Ignore it because crypto is outside banking', 'Crypto on-ramps and off-ramps run through banks. They are inside the AML perimeter.'],
    ...
    q(4107888, 'Career Skills', 'Investigations, SARs, and Quality Control', 'Negative news triage',
      ...
      [
        ...
        ['Ignore all adverse media because names repeat', 'Adverse media is a legitimate AML input. The discipline is verification, not dismissal.'],
    ...
    q(4107420, 'Career Skills', 'Investigations, SARs, and Quality Control', 'SAR clock',
      ...
      [
        ...
        ['Skip documentation because suspicion is obvious', 'SAR narratives require detailed factual support. Skipping documentation invalidates the filing.'],
      ],
    ...
    q(4107891, 'Career Skills', 'Investigations, SARs, and Quality Control', 'Continuing activity',
      ...
      [
        ['Assume the first SAR covers eternity', 'SAR guidance requires continuing-activity reports at defined intervals (typically every 90 days). The first SAR is a starting point.'],
    ...
    q(4107892, 'Career Skills', 'Investigations, SARs, and Quality Control', 'Quality assurance trend',
      ...
      [
        ...
        ['Ignore it because the alerts were closed', 'Closed alerts without documentation are exactly the QA finding. The closure itself is not the test.'],
