...
export const negotiationTopUpQuestions: Question[] = makeQuestionBank('Career Skills', [
  ...
  },
  {
    ...
    wrong: [
      ...
      miss('Ignore the relationship entirely and push only on the facts', 'Pretending the emotional rift does not exist leaves it to sabotage the substantive work; people problems must be addressed, just separately.', 'Separating is not ignoring; the relationship issue still needs handling, just on its own track.'),
    ],
