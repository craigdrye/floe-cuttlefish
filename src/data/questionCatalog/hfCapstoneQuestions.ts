...
export const hfCapstoneQuestions: Question[] = [
  ...
  q(4400516, 'Career Skills', CHAPTER, 'BIOSP options overlay vs straight short',
    ...
    [
      ...
      ['Use a smaller naked short instead of considering option-defined downside', 'Sizing down a naked short reduces the exposure linearly but does not change the open-ended loss shape on the success scenario. A smaller naked short still has unbounded upside risk — just on a smaller base.'],
    ],
  ...
  q(4400524, 'Career Skills', CHAPTER, 'Factor exposure — momentum tilt',
    ...
    [
      ...
      ['Treat fundamental conviction as enough to dismiss factor exposure', 'Fundamental funds still carry factor exposure as a byproduct of the names they pick. Ignoring the exposure because the process is fundamental is exactly how funds get surprised by factor unwinds.'],
  ...
  q(4400536, 'Career Skills', CHAPTER, 'Tone of the LP letter',
    ...
    [
      ...
      ['Lead with results and explanation while avoiding explicit accountability language', 'Skipping acknowledgment entirely is the move that reads as defensive. Sophisticated LPs notice when a letter jumps straight to explanation without naming the disappointment — it is the small move that loses trust.'],
    ],
  ...
  q(4400542, 'Career Skills', CHAPTER, 'Rebalancing the short book',
    ...
    [
      ...
      ['Full-size the less crowded shorts while underweighting shared factor and liquidity risk', 'Full-sizing into the non-crowded names without considering single-name diligence depth produces a sizing decision driven by avoidance, not conviction. The right move is to allocate selectively at conviction-driven sizes, not maximally into the alternative.'],
  ...
  q(4400548, 'Career Skills', CHAPTER, 'Stop-loss discipline on the BIOSP short',
    ...
    [
      ...
      ['Treat thesis conviction and an approaching catalyst as reasons to override the stop', 'Ignoring the stop is the symmetric error to mechanical application. The stop\'s purpose is to force a re-underwriting at adverse price action, and skipping that re-underwriting because the thesis is intact misses the discipline the stop is meant to enforce.'],
