...
export const UNIVERSITY_SUB_TOPICS: Record<string, number[]> = {
  ...
  // -------------------- Marketing (uses 169xx) --------------------
  // NOTE: these IDs collide with Org Chem Stretch Zone (16901-16910). Polish
  // hints below favor the marketing context; org chem hints for the same IDs
  // ride on the generic scaffold.
  'Marketing: STP & Positioning': [16909, 16910],
  'Marketing: Strategy & Frameworks': [16905, 16906, 16911],
  'Marketing: Consumer & Research': [16907, 16908],
  'Marketing: Value & Brand': [16902, 16903],
  'Marketing: Promotion & Metrics': [16912, 16913, 16904],
  'Marketing: Behavioral Pricing': [16914],
...
export const UNIVERSITY_MENTOR_HINTS: Record<number, string> = {
  ...
  // 16901–16910 chemistry Stretch Zone hints collide with marketing track IDs;
  // marketing hints (below) take precedence — orgchem Stretch Zone uses generic scaffold.
  ...
  16605: 'Philosophy proceeds by argument and analysis, not authority or revelation.',
  16606: 'Metaphysics asks what exists; epistemology asks how we know; ethics asks what we ought to do.',
  16607: 'Empiricism: knowledge through sense experience. Rationalism: knowledge through pure reason.',
  16608: 'Utilitarianism aggregates wellbeing; deontology obeys rules regardless of outcome.',
  16609: 'Sound argument = valid AND all premises true. Validity alone is not enough.',
  16610: 'Deductive validity is purely formal: if the premises are true, the conclusion must be.',
  ...
  16615: 'Hume on induction: no non-circular justification for assuming the future resembles the past.',
  ...
  16618: 'Mary the color scientist: physicalism vs qualia. What does she learn upon seeing red?',
  16619: 'Foundationalism vs coherentism: how does justification stop regressing?',
  16620: "Rawls' veil of ignorance: choose principles without knowing your position. Justice as fairness.",
  16621: 'Virtue ethics: focus on character traits, not actions or consequences. Aristotle is the anchor.',
  16622: "Dualism vs physicalism: is mind reducible to brain? Descartes' interaction problem haunts dualism.",
  16623: "Modal realism (Lewis): all possible worlds are equally real. Most philosophers find it extravagant.",
  16624: 'Error theory (Mackie): moral claims purport to describe objective values, but no such values exist.',
  17201: 'Cogito: the very act of doubting requires a doubter. Self-existence is the indubitable starting point.',
  17202: 'Hard problem of consciousness: why is there subjective experience at all, alongside the functional story?',
  17203: 'Trolley variants test whether the moral difference between killing and letting die is real or status-quo bias.',
  17204: 'Rule utilitarianism: follow rules whose general adoption maximizes utility, not act-by-act calculation.',
  17205: "Plato's forms: abstract universals are more real than their particular instances. The realm of forms is ontologically primary.",
  17206: 'Phenomenology brackets metaphysics and describes the structure of conscious experience directly.',
  17207: "Nietzsche's master-slave morality genealogy: tracing how moral concepts emerge from power structures.",
  17208: "Quine's web of belief: no analytic-synthetic distinction. Beliefs are revisable holistically.",
  17209: 'Externalism about meaning (Putnam, Burge): twin-earth thought experiments show meaning depends on environment.',
  17210: "Derek Parfit on personal identity: what matters is psychological continuity, not numerical identity.",
  ...
  // ---------- Marketing (169xx) ----------
  16901: 'Marketing target = the specific audience the message and product address. Not everyone, on purpose.',
  16902: 'A brand creates recognition and shapes expectations — that is its core economic function.',
  16903: 'Value proposition = the customer-facing reason to choose this product over alternatives.',
  16904: 'A conversion is the user completing the action you wanted — purchase, signup, install.',
  16905: 'BCG: Question Mark = low share, high growth. Investment decision: turn it into a Star, or divest.',
  16906: 'PESTLE scans macro-environmental forces — political, economic, social, technological, legal, environmental.',
  16907: 'Post-purchase dissonance is buyers remorse. High-involvement decisions trigger it.',
  16908: 'Primary data is gathered for your specific question — tailored but expensive. Secondary data is repurposed.',
  16909: 'Psychographics segment by mind: lifestyle, values, attitudes, interests.',
  16910: 'Perceptual maps plot brands on two attribute axes from the customer perspective. Gaps suggest positioning opportunities.',
  16911: 'Penetration pricing: low entry price to capture share fast, accept thin margins, scale with volume.',
  16912: 'PR is earned media — no payment, no message control, reputation-building.',
  16913: 'LTV >> CAC is the sustainability test. The 3:1 ratio is the working benchmark.',
  16914: 'Decoy effect: an asymmetrically dominated third option steers choice toward a target alternative.',
