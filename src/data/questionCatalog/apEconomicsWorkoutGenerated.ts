...
const _baseApEconomicsWorkoutGeneratedQuestions = makeQuestionBank('AP', [
  ...
  q(402014, 'Chapter 2: Supply, Demand, Elasticity, and Welfare', 'Inelastic demand', 'If demand is inelastic, a price increase causes total revenue to:', 'Increase', [miss('Decrease', 'For inelastic demand, quantity falls proportionally less than price rises.', 'Revenue follows price effect.'), miss('Become zero', 'Not generally.', 'Use elasticity-total revenue test.'), miss('Stay mathematically impossible', 'Revenue is price times quantity.', 'Compare percentage changes.')]),
