...
export const bcCapstoneQuestions: Question[] = [
  ...
  q(4420510, 'Career Skills', CHAPTER, 'False-positive baseline measurement',
    ...
    [
      ...
      ['Start tuning immediately and reconstruct the baseline afterward from archived alert data', 'Without a clean pre-tuning baseline, there is no credible way to demonstrate improvement. The OCC will ask for the comparison; a reconstructed baseline is read as either avoidance or a measurement problem.'],
    ],
  ...
  q(4420539, 'Career Skills', CHAPTER, 'Quality-control sampling during throughput',
    ...
    [
      ...
      ['Run clearance at maximum speed and leave quality review to audit after the push', 'Pushing throughput without concurrent QC trades short-term volume for long-term remediation pain — issues compound through the backlog and surface in audit findings or in the OCC follow-up exam. QC during the run is cheaper than rework after.'],
    ],
  ...
  q(4420544, 'Career Skills', CHAPTER, 'Root cause vs symptom in response letter',
    ...
    [
      ...
      ['Treat the exam language itself as the root-cause analysis', 'The exam findings describe what was observed, not necessarily the bank\'s articulation of why. The bank\'s own root-cause analysis is what demonstrates internalization and program understanding — recycling the finding leaves the impression that the bank does not see beyond the symptom.'],
