...
export const geometryExamBatchQuestions = makeQuestionBank('Mathematics', [
  q(437001, 'Chapter 1: Geometry Foundations and Proof Habits', 'Vertical angles', 'Two lines intersect. Which statement is always true about a pair of vertical angles?', 'They are congruent', [
  ...
  q(437002, 'Chapter 3: Triangles, Parallels, and Formal Proof', 'Corresponding angles', 'Two parallel lines are cut by a transversal. If one corresponding angle is 72 degrees, what is the other corresponding angle?', '72 degrees', [
  ...
  q(437003, 'Chapter 3: Triangles, Parallels, and Formal Proof', 'SAS criterion', 'Which information is enough to prove two triangles congruent by SAS?', 'Two pairs of corresponding sides and the included angle', [
  ...
  q(437004, 'Chapter 4: Similarity, Dilations, and Scale', 'AA similarity', 'Which condition is enough to prove two triangles are similar?', 'Two pairs of corresponding angles are congruent', [
  ...
  q(437005, 'Chapter 5: Right Triangles and Trigonometry Basics', 'Pythagorean converse', 'A triangle has side lengths 7, 24, and 25. What can you conclude?', 'It is a right triangle', [
  ...
  q(437006, 'Chapter 6: Circles and Circular Measurement', 'Tangent radius', 'A radius is drawn to a point of tangency on a circle. What angle does it make with the tangent line?', '90 degrees', [
  ...
  q(437007, 'Chapter 7: Coordinate Geometry and Algebraic Proof', 'Parallel slopes', 'A line has slope -2. What is the slope of any line parallel to it?', '-2', [
  ...
  q(437008, 'Chapter 7: Coordinate Geometry and Algebraic Proof', 'Perpendicular slopes', 'A line has slope 3/4. What is the slope of a line perpendicular to it?', '-4/3', [
  ...
  q(437009, 'Chapter 2: Transformations and Congruence', 'Reflection over y-axis', 'Reflect the point (-5, 2) over the y-axis. What is the image?', '(5, 2)', [
  ...
  q(437010, 'Chapter 8: Area, Volume, and Geometry Modeling Studio', 'Cylinder volume', 'What is the volume of a cylinder with radius 3 and height 10?', '90pi', [
