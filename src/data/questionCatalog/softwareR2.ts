...
export const softwareR2Questions: Question[] = makeQuestionBank('Career Skills', [
  ...
  { id: 7652037, chapter: 'Security and Secrets', title: 'Triaging a vulnerable dependency',
    ...
    wrong: [
      ...
      miss('Treat scanner results as noise before testing exploitability in your stack', 'Blanket-ignoring is the opposite failure; some CVEs are genuinely exploitable in your context and must be patched.', 'Dismissing all alerts misses the ones that actually reach your code.'),
