...
export const ibCapstoneQuestions: Question[] = [
  ...
  q(4351510, 'Career Skills', CHAPTER, 'Management presentation deck structure',
    ...
    [
      ...
      ['Skip the working-capital section in the deck — it can be addressed in Q&A if buyers raise it', 'Working capital will be raised in Q&A regardless; addressing it proactively in the deck signals confidence and pre-empts the bidder building their own less-favorable story. Reactive answers in Q&A always carry less weight.'],
    ],
  ...
  q(4351519, 'Career Skills', CHAPTER, 'Reading bidder behavior between rounds',
    ...
    [
      ['Assume the sponsor has dropped out and reallocate management meeting time to the other five', 'Assuming a drop-out before confirming closes a real bidder. The cost of the call is low; the cost of losing a $700M bidder over uninformed assumption is high.'],
  ...
  q(4351525, 'Career Skills', CHAPTER, 'Synergy crediting in strategic bids',
    ...
    [
      ...
      ['Ignore synergies in the recommendation since they are speculative until integration is executed', 'Ignoring synergies treats the strategic\'s $70M premium as unexplained, which means the recommendation cannot tell the board why the strategic is paying more than the sponsor. Synergies are the explanation — they have to be in the document.'],
  ...
  q(4351529, 'Career Skills', CHAPTER, 'Family minority rollover mechanics',
    ...
    [
      ...
      ['Skip the shareholders agreement and rely on standard minority protections in state law', 'State-law minority protections are weaker than what a private-equity rollover requires — without explicit tag, drag, information, and waterfall language, the family is exposed to exit terms that disadvantage them relative to the sponsor.'],
  ...
  q(4351532, 'Career Skills', CHAPTER, 'Confidentiality during exclusivity',
    ...
    [
      ...
      ['Skip enhanced remedies since damages from leak would be hard to prove and remedies do not stop leaks anyway', 'Damages are exactly the reason injunctive relief is the right remedy — proving dollar damages from a customer loss is hard, but injunctive relief lets the seller stop the disclosure mid-flight. Skipping the remedy weakens the deterrent.'],
  ...
  q(4351535, 'Career Skills', CHAPTER, 'R&W insurance — retention and policy limit',
    ...
    [
      ...
      ['Skip R&W insurance and rely on indemnification escrow for the full rep package', 'Indemnification-only structures require a large escrow (typically 10%+ of EV) tied up for 12–24 months. R&W insurance frees the seller\'s proceeds and is now market standard above $250M — skipping it is non-market.'],
  ...
  q(4351538, 'Career Skills', CHAPTER, 'Fairness opinion scope and audience',
    ...
    [
      ['Skip the fairness opinion since the auction process itself validates fair value', 'Auction-as-fairness is a common shortcut but does not substitute for the formal opinion the board\'s fiduciary record needs. The opinion is the document the board produces when challenged — and the auction outcome is one input to it, not a replacement for it.'],
  ...
  q(4351541, 'Career Skills', CHAPTER, 'HSR filing strategy and second-request risk',
    ...
    [
      ...
      ['Skip pre-arranged divestiture commitments and negotiate any required divestitures only if the agency raises issues', 'Pre-arranged divestitures with a credible divestiture buyer in the bag are how mid-market overlap deals clear without second requests. Reactive divestiture negotiation under second-request pressure is materially weaker leverage and longer timeline.'],
  ...
  q(4351542, 'Career Skills', CHAPTER, 'Working-capital true-up at closing',
    ...
    [
      ...
      ['Skip the working-capital adjustment entirely since the price is already negotiated', 'Skipping the working-capital adjustment exposes the buyer to a closing-date balance sheet that is materially below normalized levels — which is a real economic transfer. Buyers will not accept skipping; the negotiation is on the target and the methodology, not the existence.'],
