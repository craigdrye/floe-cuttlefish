...
const _baseSchoolAssessmentReadingWritingQuestions = makeQuestionBank('AP', [
  q({
    id: 464001,
...
const _baseSchoolAssessmentUsHistoryQuestions = makeQuestionBank('AP', [
  q({
    id: 464101,
...
const _baseSchoolAssessmentLogicArgumentationQuestions = makeQuestionBank('Extension', [
  q({
    id: 464201,
...
export const schoolAssessmentReadingWritingQuestions = runPolish(
  _baseSchoolAssessmentReadingWritingQuestions,
  _schoolAssessmentPolishBundles,
)
export const schoolAssessmentUsHistoryQuestions = runPolish(
  _baseSchoolAssessmentUsHistoryQuestions,
  _schoolAssessmentPolishBundles,
)
export const schoolAssessmentLogicArgumentationQuestions = runPolish(
  _baseSchoolAssessmentLogicArgumentationQuestions,
  _schoolAssessmentPolishBundles,
)
