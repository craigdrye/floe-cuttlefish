...
export const ibCh5Questions: Question[] = [
  ...
  q(4351416, 'Career Skills', CHAPTER, 'The final_final_v3_clean anti-pattern',
    ...
    [
      ...
      ['Treat the file with "REAL" in the name as the latest convention', 'Convention-by-suffix is the disease, not the cure. "REAL", "FINAL", "v3_clean" are all someone\'s guess that their file is the real one — the only authoritative anchor is which file has actually been sent up in the most recent email.'],
  ...
  q(4351427, 'Career Skills', CHAPTER, 'CC discipline on external emails',
    ...
    [
      ...
      ['Send it externally with no cc line, then forward it internally afterward', 'Forwarding-after is fine for internal awareness but it loses the audit trail — the sent email\'s addressing is the record of who was officially in the conversation. Cc the seniors required, bcc the rest.'],
  ...
  q(4351437, 'Career Skills', CHAPTER, 'Font sizes, header conventions, page breaks',
    ...
    [
      ...
      ['Remove the section divider pages because every page needs analysis', 'Section dividers are not waste — they break the deck into navigable sections for a reader flipping through under time pressure. Cutting them to save pages defeats the navigation logic of a pitch.'],
    ],
