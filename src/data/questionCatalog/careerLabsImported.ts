...
const _careerLabsMedicalQuestionsBase = makeQuestionBank('Medical', [
  {
    id: 4210001,
...
const _careerLabsClinicalResearchQuestionsBase = makeQuestionBank('Clinical Research', [
  {
    id: 4210101,
...
const _careerLabsRegulatoryQuestionsBase = makeQuestionBank('Regulatory', [
  {
    id: 4210201,
...
export const careerLabsMedicalQuestions = runPolish(_careerLabsMedicalQuestionsBase, _miscBundle)
export const careerLabsClinicalResearchQuestions = runPolish(_careerLabsClinicalResearchQuestionsBase, _miscBundle)
export const careerLabsRegulatoryQuestions = runPolish(_careerLabsRegulatoryQuestionsBase, _miscBundle)
