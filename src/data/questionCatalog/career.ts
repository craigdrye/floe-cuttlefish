  ...
  priyasBrutalSurgeonsQuiz: makeQuestionBank('Medical', [
    ...
    },
    {
      ...
      wrong: [
        ...
        ['Skip laparoscopy unless ascites, ovarian enlargement, or omental caking appears on imaging, because cytology is only useful when macroscopic peritoneal disease is suspected', 'The point of laparoscopy and washings is to find radiographically occult disease, especially in high-risk gastric cancers.', 'Absence of visible peritoneal disease on CT is the reason to look, not the reason to relax.'],
      ],
    },
    {
      id: 51973,
    ...
    },
    {
      ...
      wrong: [
        ['Skip laparoscopy because PET/CT has excluded metastatic disease', 'Peritoneal disease and positive cytology are often missed by cross-sectional imaging and PET, especially in diffuse-type gastric cancer.', 'The peritoneum is a stealth organ.'],
