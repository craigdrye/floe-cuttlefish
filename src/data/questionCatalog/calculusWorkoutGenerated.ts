...
export const calculusWorkoutGeneratedQuestions = makeQuestionBank('Mathematics', [
  q(396001, 'Limits', 'Direct substitution', 'Evaluate lim x->2 of (x^2 + 3).', '7', [
  ...
  q(396002, 'Limits', 'Removable factor', 'Evaluate lim x->3 of (x^2 - 9)/(x - 3).', '6', [
  ...
  q(396003, 'Limits', 'One-sided mismatch', 'If lim x->1- f(x) = 2 and lim x->1+ f(x) = 5, then lim x->1 f(x):', 'Does not exist', [
  ...
  q(396004, 'Limits', 'Infinite behavior', 'As x approaches 0 from the right, 1/x approaches:', 'Positive infinity', [
  ...
  q(396005, 'Continuity', 'Continuity at a point', 'A function is continuous at x = a when:', 'f(a) exists, the limit exists, and they are equal', [
  ...
  q(396006, 'Derivatives', 'Power rule', 'What is d/dx of x^5?', '5x^4', [
  ...
  q(396007, 'Derivatives', 'Constant derivative', 'What is d/dx of 11?', '0', [
  ...
  q(396008, 'Derivatives', 'Linearity', 'What is d/dx of 3x^2 - 4x + 9?', '6x - 4', [
  ...
  q(396009, 'Derivatives', 'Product rule', 'Differentiate f(x) = x^2 sin x.', '2x sin x + x^2 cos x', [
  ...
  q(396010, 'Derivatives', 'Quotient rule', 'For f(x) = x/(x + 1), f\'(x) equals:', '1/(x + 1)^2', [
  ...
  q(396011, 'Derivatives', 'Chain rule', 'Differentiate (2x + 5)^3.', '6(2x + 5)^2', [
  ...
  q(396012, 'Derivatives', 'Exponential derivative', 'What is d/dx of e^(3x)?', '3e^(3x)', [
  ...
  q(396013, 'Derivatives', 'Log derivative', 'What is d/dx of ln x?', '1/x', [
  ...
  q(396014, 'Derivatives', 'Trig derivative', 'What is d/dx of cos x?', '-sin x', [
  ...
  q(396021, 'Integrals', 'Basic antiderivative', 'An antiderivative of 4x^3 is:', 'x^4 + C', [
  ...
  q(396022, 'Integrals', 'Constant of integration', 'Why do indefinite integrals include + C?', 'Because functions differing by a constant have the same derivative', [
  ...
  q(396023, 'Integrals', 'Definite integral meaning', 'A definite integral of velocity over time gives:', 'Change in position', [
  ...
  q(396024, 'Integrals', 'FTC evaluation', 'Evaluate integral from 0 to 2 of 3x^2 dx.', '8', [
  ...
  q(396025, 'Integrals', 'Area below axis', 'If f(x) is below the x-axis on an interval, its definite integral over that interval is:', 'Negative signed area', [
  ...
  q(396026, 'Integrals', 'U-substitution clue', 'Which integral most clearly invites u = x^2 + 1?', 'Integral of 2x cos(x^2 + 1) dx', [
  ...
  q(396027, 'Integrals', 'Integration by parts', 'Integration by parts is most directly based on:', 'The product rule', [
  ...
  q(396028, 'Integrals', 'Average value', 'The average value of f on [a,b] is:', '(1/(b-a)) integral_a^b f(x) dx', [
  ...
  q(396029, 'Differential Equations', 'Separable equation', 'dy/dx = xy is separable because it can be written as:', 'dy/y = x dx', [
  ...
  q(396030, 'Differential Equations', 'Initial condition', 'An initial condition is used to:', 'Find the particular solution from a family of solutions', [
  ...
  q(396045, 'Differential Equations', 'Slope field', 'A slope field visualizes:', 'The derivative dy/dx at many points', [
