...
const _baseNumbasWebworkAlgebraQuestions = makeQuestionBank('Mathematics', [
  q({
    id: 461001,
...
const _baseNumbasWebworkCalculusQuestions = makeQuestionBank('Mathematics', [
  q({
    id: 461101,
...
const _baseNumbasWebworkLinearAlgebraQuestions = makeQuestionBank('Mathematics', [
  q({
    id: 461201,
    chapter: 'Matrices',
...
const _baseNumbasWebworkStatisticsQuestions = makeQuestionBank('Statistics', [
  q({
    id: 461301,
...
export const numbasWebworkAlgebraQuestions = runPolish(_baseNumbasWebworkAlgebraQuestions, _numbasBundle)
