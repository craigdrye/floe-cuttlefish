...
export const statisticsExamBatchQuestions = makeQuestionBank('Mathematics', [
  ...
  q(440003, 'Chapter 3: Normal Models and Standardization', 'Standard score', 'A value is 2 standard deviations above the mean. What is its z-score?', '2', [
  ...
  q(440004, 'Chapter 3: Normal Models and Standardization', 'Empirical rule', 'In an approximately normal distribution, about what percent of values lie within 2 standard deviations of the mean?', '95%', [
  ...
  q(440005, 'Chapter 7: Sampling Variability and Introductory Inference', 'Confidence meaning', 'A 95% confidence interval is made by a reliable method. What does 95% refer to?', 'The long-run success rate of the interval method', [
  ...
  q(440006, 'Chapter 7: Sampling Variability and Introductory Inference', 'Type I error', 'In a hypothesis test, what is a Type I error?', 'Rejecting a true null hypothesis', [
  ...
  q(440008, 'Chapter 4: Two-Variable Data and Regression', 'Correlation sign', 'If correlation r = -0.82, what does that say about the linear relationship?', 'Strong negative linear association', [
  ...
  q(440009, 'Chapter 7: Sampling Variability and Introductory Inference', 'Statistical significance', 'A test result is statistically significant at alpha = 0.05. Which statement is best?', 'The p-value is less than 0.05', [
  ...
  q(440010, 'Chapter 6: Probability and Random Variables', 'Permutation or combination', 'A race awards gold, silver, and bronze among 8 runners. Which counting method fits?', 'Permutation, because order matters', [
