  ...
  bankComplianceAmlRoadmap: [
    ...
    q(4103132, 'Career Skills', 'KYC and Customer Risk', 'Beneficial ownership rabbit hole',
      ...
      [
        ...
        ['Ignore the consultant because only signers matter', 'Control under 31 CFR 1010.230 includes actual control, not just signature authority; bypass control is exactly what the rule targets.'],
    ...
    q(4103136, 'Career Skills', 'KYC and Customer Risk', 'Risk rating drift',
      ...
      [
        ...
        ['Ignore adverse media because it arrived after onboarding', 'The CDD Rule\'s ongoing monitoring obligation explicitly includes information learned after onboarding.'],
      ],
    ...
    q(4103137, 'Career Skills', 'Transaction Monitoring and Alerts', 'Narrative that travels',
      ...
      [
        ['A screenshot-only file with no written reasoning', 'Screenshots do not capture the analyst\'s reasoning; FinCEN narrative guidance is explicit that the reviewer must follow the logic.'],
  ...
  defenseBudgetingRoadmap: [
    ...
    q(4107906, 'Career Skills', 'Budget Communication and Oversight', 'Congressional marks response',
      ...
      [
        ...
        ['The logo on the briefing deck', 'Branding does not address the underlying schedule-confidence concern Congress signaled.'],
      ],
  ...
  procurementContractingRoadmap: [
    ...
    q(4103116, 'Career Skills', 'Requirements and Acquisition Planning', 'Need before solution',
      ...
      [
        ...
        ['Skip market research because a stakeholder has a favorite', 'FAR Part 10 requires market research before solicitation; favorites do not satisfy CICA full-and-open competition.'],
      ],
    ...
    q(4103117, 'Career Skills', 'Sourcing and Solicitation', 'Evaluation criteria mismatch',
      ...
      [
        ...
        ['The vendor with the best logo must win', 'Branding is not an evaluation factor under FAR 15.304; awards based on unstated criteria invite protest.'],
    ...
    q(4103160, 'Career Skills', 'Evaluation, Negotiation, and Award', 'Equal discussions discipline',
      ...
      [
        ...
        ['Detailed feedback is always illegal for everyone', 'Discussions feedback is required, not prohibited; the failure mode is unequal treatment, not feedback itself.'],
    ...
    q(4103155, 'Career Skills', 'Evaluation, Negotiation, and Award', 'Past performance relevance',
      ...
      [
        ...
        ['Ignore all past performance because price is easier to count', 'FAR 15.304(c)(3) makes past performance a required evaluation factor in negotiated procurements above the simplified acquisition threshold.'],
        ['Score the vendor based on whether the team likes their logo', 'Logo aesthetics are not a FAR 15.305 evaluation factor; using them invites protest.'],
      ],
    ...
    q(4107459, 'Career Skills', 'Evaluation, Negotiation, and Award', 'Responsibility determination',
      ...
      [
        ...
        ['Ignore integrity records if the price is convenient', 'FAR 9.104-1(d) explicitly requires "satisfactory record of integrity and business ethics"; price does not override.'],
    ...
    q(4103120, 'Career Skills', 'Contract Administration and Closeout', 'Scope creep fork',
      ...
      [
        ...
        ['Ignore it because administration starts only at closeout', 'Contract administration runs from award to closeout under FAR Part 42; not just closeout.'],
      ],
    ...
    q(4103156, 'Career Skills', 'Contract Administration and Closeout', 'Invoice versus performance evidence',
      ...
      [
        ...
        ['Ignore labor categories until closeout', 'Labor category review is contemporaneous; closeout-only review allows incorrect payments to accumulate beyond recovery.'],
      ],
    ...
    q(4107461, 'Career Skills', 'Contract Administration and Closeout', 'Final CPARS rating',
      ...
      [
        ...
        ['Skip the record because the work is already over', 'FAR 42.1502 requires CPARS evaluations for contracts above defined thresholds; skipping them is non-compliance.'],
      ],
  ...
  nationalSecurityPolicyRoadmap: [
    ...
    q(4103163, 'Career Skills', 'Intelligence and Evidence', 'Source caveat on OSINT',
      ...
      [
        ...
        ['Exclude all open-source material because it is never useful', 'OSINT is a recognized IC discipline (e.g., DNI Open Source Enterprise); blanket exclusion discards valuable information.'],
    ...
    q(4107935, 'Career Skills', 'Instruments of National Power', 'Sanctions targeting evidence',
      ...
      [
        ...
        ['Skip evidence because "sanctions are a vibe-based tool"', 'Sanctions designations are subject to administrative review (OFAC reconsideration, APA challenges); evidence is required, not optional.'],
    ...
    q(4107938, 'Career Skills', 'Instruments of National Power', 'Leahy vetting',
      ...
      [
        ...
        ['Ignore reports until the press asks', 'State Department\'s INVEST process aggregates open-source reporting precisely so credible reports cannot be ignored.'],
