...
const _baseStatisticsReasoningWorkoutGeneratedQuestions = makeQuestionBank('Statistics', [
...
export const statisticsReasoningWorkoutGeneratedQuestions = runPolish(_baseStatisticsReasoningWorkoutGeneratedQuestions, [
