...
export const ibCh1Questions: Question[] = [
  ...
  q(4351010, 'Career Skills', CHAPTER, 'What makes an IOI comparable',
    ...
    [
      ...
      ['Pick the all-cash bid ($590M) because certainty always beats nominal price', 'Certainty matters but not unconditionally. A $590M certain bid is not obviously better than $620M with a 90% probability of closing; the analyst\'s job is to do that math, not assume away the comparison.'],
