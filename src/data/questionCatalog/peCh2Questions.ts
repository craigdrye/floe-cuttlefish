...
export const peCh2Questions: Question[] = [
  ...
  q(4390139, 'Career Skills', CHAPTER, 'Dividend recap mechanics',
    ...
    [
      ...
      ['Recaps are illegal because they transfer value from lenders to equity', 'Recaps are legal and contractually permitted under the credit agreement\'s permitted dividend baskets. Lenders price the option ex ante; the recap is not a violation, even if lenders dislike it.'],
