...
export function buildUniversityCollegeQuestionCatalog(): Record<string, Question[]> {
  return {
  'col-class-11-math': makeIndiaClass11MathQuiz(),
  'col-class-12-math': makeIndiaClass12MathQuiz(),
  'col-ap-college-calculus-ab': makeColCalculusABQuiz(),
  'col-ap-college-statistics': makeColAPStatisticsQuiz(),
  'col-college-algebra': makeColCollegeAlgebraQuiz(),
  'col-ap-college-calculus-bc': makeColCalculusBCQuiz(),
  'col-eureka-math-precalculus': makeColPrecalculusQuiz(),
