...
export function buildUniversityCollegeQuestionCatalog(): Record<string, Question[]> {
  ...
  'col-college-algebra': collegeAlgebra,
  'col-eureka-math-precalculus': precalculus,
  class11Math,
  class12Math,
  apCalculusAB: [...calculusAB, ...calculusWorkoutGeneratedQuestions],
  apStatistics: [
    ...apStatistics,
  ...
  collegeAlgebra,
  collegeAlgebraWorkout: collegeAlgebraWorkoutGeneratedQuestions,
  apCalculusBc: [...calculusBC, ...apCalculusBcNumbasBatchQuestions],
