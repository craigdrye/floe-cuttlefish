...
export const numbasWebworkAdditionalAlgebraQuestions = makeQuestionBank('Mathematics', [
  q({
    id: 466001,
    chapter: 'Logarithms',
...
export const numbasWebworkAdditionalTrigonometryQuestions = makeQuestionBank('Mathematics', [
  q({
    id: 466101,
...
export const numbasWebworkAdditionalCalculusQuestions = makeQuestionBank('Mathematics', [
  q({
    id: 466201,
    chapter: 'Chain Rule',
...
export const numbasWebworkAdditionalLinearAlgebraQuestions = makeQuestionBank('Mathematics', [
  q({
    id: 466301,
...
export const numbasWebworkAdditionalStatisticsQuestions = makeQuestionBank('Statistics', [
  q({
    id: 466401,
