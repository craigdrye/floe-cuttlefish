...
export const openTriviaCuratedGeographyAdditionalQuestions = makeQuestionBank('AP', [
  {
    id: 381001,
...
export const openTriviaCuratedLanguageCultureAdditionalQuestions = makeQuestionBank('AP', [
  {
    id: 381009,
...
export const openTriviaCuratedHistoryAdditionalQuestions = makeQuestionBank('AP', [
  {
    id: 381012,
...
export const openTriviaCuratedBiologyAdditionalQuestions = makeQuestionBank('AP', [
  {
    id: 381027,
    chapter: 'Evolution and Classification',
    source: 'OpenTriviaQA',
    title: 'Phylogenetics',
    prompt: 'Which term denotes the classification of organisms based on their evolutionary descent?',
    correct: 'Phylogenetics',
    wrong: [distractor('biology', 'Ornithology'), distractor('biology', 'Neuroethology'), distractor('biology', 'Paleontology')],
    lesson: 'Source: OpenTriviaQA (opentriviaqa::science-technology::339). Included in the reviewed OpenTriviaQA curated additional pass.',
  },
  {
    id: 381028,
    chapter: 'Evolution and Classification',
    ...
    prompt: 'What evolutionary process makes beneficial inherited traits more common in later generations and unfavorable inherited traits less common?',
    correct: 'Natural Selection',
    wrong: [distractor('biology', 'Random Genetic Drift'), distractor('biology', 'Gene Flow'), distractor('biology', 'Macro Evolution')],
    lesson: 'Source: OpenTriviaQA (opentriviaqa::science-technology::996). Included in the reviewed OpenTriviaQA curated additional pass.',
  },
  {
    id: 381029,
    ...
    source: 'OpenTriviaQA',
    title: 'Amino Acids',
    prompt: 'What is the number of amino acids commonly associated with mammalian proteins?',
    correct: '20',
    wrong: [distractor('biology', '25'), distractor('biology', '23'), distractor('biology', '46')],
    lesson: 'Source: OpenTriviaQA (opentriviaqa::science-technology::1341). Included in the reviewed OpenTriviaQA curated additional pass.',
  },
  {
    id: 381030,
    chapter: 'Proteins and Nucleic Acids',
    source: 'OpenTriviaQA',
    title: 'Alpha Amino Acids',
    prompt: 'Mammalian amino acids are commonly described by which Greek letter designating their relation to the central carbon atom?',
    correct: 'Alpha',
    wrong: [distractor('biology', 'Delta'), distractor('biology', 'Sigma'), distractor('biology', 'Beta')],
    lesson: 'Source: OpenTriviaQA (opentriviaqa::science-technology::1342). Included in the reviewed OpenTriviaQA curated additional pass.',
  },
  {
    id: 381031,
    chapter: 'Proteins and Nucleic Acids',
    source: 'OpenTriviaQA',
    title: 'RNA Function',
    prompt: 'Which nucleic acid has a main function of copying genetic information?',
    correct: 'RNA',
    wrong: [distractor('biology', 'REO'), distractor('biology', 'RSI'), distractor('biology', 'RAROC')],
    lesson: 'Source: OpenTriviaQA (opentriviaqa::humanities::950). Included in the reviewed OpenTriviaQA curated additional pass.',
  },
])
...
export const openTriviaCuratedPhysicalScienceAdditionalQuestions = makeQuestionBank('AP', [
  {
    ...
    prompt: 'The law of inertia is also referred to as which law?',
    correct: "Newton's First Law",
    wrong: [distractor('physics', "Newton's Third Law"), distractor('physics', 'Fundamental law of dynamics'), distractor('physics', "Newton's Second Law")],
    lesson: 'Source: OpenTriviaQA (opentriviaqa::science-technology::352). Included in the reviewed OpenTriviaQA curated additional pass.',
  },
  {
    id: 381033,
    chapter: 'Waves and Electricity',
    source: 'OpenTriviaQA',
    title: 'Frequency',
    prompt: 'Which term refers to the number of complete cycles of an alternating current that occur per second?',
    correct: 'Frequency',
    wrong: [distractor('physics', 'Watt'), distractor('physics', 'Wavelength'), distractor('physics', 'Ohm')],
    lesson: 'Source: OpenTriviaQA (opentriviaqa::science-technology::664). Included in the reviewed OpenTriviaQA curated additional pass.',
  },
  {
    id: 381034,
    ...
    prompt: 'According to the third law of thermodynamics, what happens to the entropy of a system as temperature approaches absolute zero?',
    correct: 'It approaches a constant, often described as zero for a perfect crystal.',
    wrong: [distractor('physics', "It approaches Avogadro's number."), distractor('physics', 'It approaches critical mass.'), distractor('physics', 'It approaches infinity.')],
    lesson: 'Source: OpenTriviaQA (opentriviaqa::science-technology::1217). Included in the reviewed OpenTriviaQA curated additional pass.',
  },
  {
    id: 381035,
    ...
    source: 'OpenTriviaQA',
    title: 'CERN',
    prompt: 'The giant subatomic particle collider capable of reproducing early-universe conditions is located at which research facility?',
    correct: 'CERN',
    wrong: [distractor('physics', 'NASA'), distractor('physics', 'None of these'), distractor('physics', 'KAOS')],
    lesson: 'Source: OpenTriviaQA (opentriviaqa::science-technology::1303). Included in the reviewed OpenTriviaQA curated additional pass.',
  },
])

export const openTriviaCuratedEnvironmentalScienceAdditionalQuestions = makeQuestionBank('University', [
  {
    id: 381036,
...
export const openTriviaCuratedLiteratureAdditionalQuestions = makeQuestionBank('AP', [
  {
    id: 381039,
    chapter: 'Shakespeare',
    source: 'OpenTriviaQA',
...
export const openTriviaCuratedArtHistoryAdditionalQuestions = makeQuestionBank('University', [
  {
    id: 381047,
    chapter: 'Renaissance Art',
    source: 'OpenTriviaQA',
    title: 'Botticelli Apprenticeship',
    prompt: 'Which Renaissance artist was at first apprenticed to a goldsmith?',
    correct: 'Alessandro Botticelli',
    wrong: [distractor('art history', 'Raphael Sanzio'), distractor('art history', 'Leonardo da Vinci'), distractor('art history', 'Michelangelo Caravaggio')],
    lesson: 'Source: OpenTriviaQA (opentriviaqa::humanities::274). Included in the reviewed OpenTriviaQA curated additional pass.',
  },
  {
    id: 381048,
    chapter: 'Renaissance Art',
    source: 'OpenTriviaQA',
    title: 'Titian',
    prompt: 'Which of the following works was painted by Titian, one of the most famous painters of the Venetian school?',
    correct: 'Penitent Mary Magdalene',
    wrong: [distractor('art history', 'Madonna and Child Blessing'), distractor('art history', 'Martha and Mary Magdalene'), distractor('art history', 'Madonna della Scala')],
    lesson: 'Source: OpenTriviaQA (opentriviaqa::humanities::892). Included in the reviewed OpenTriviaQA curated additional pass.',
  },
])
