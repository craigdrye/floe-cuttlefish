...
const q = (
  ...
  wrong,
  lesson:
    'Coverage source: OpenDSA algorithms, software design, list, hashing, sorting, and analysis clusters. This is an authored Floe-native drill item, not a direct raw import.',
...
const _baseApComputerScienceWorkoutGeneratedQuestions = makeQuestionBank('AP', [
  ...
  q(403031, 'Chapter 7: Searching, Sorting, Recursion, AP FRQ Reasoning', 'Recursive step', 'A recursive step should usually move the problem toward:', 'The base case', [miss('A larger unsolved problem forever', 'That risks infinite recursion.', 'Progress toward stopping.'), miss('A syntax error', 'No.', 'Reduce or simplify input.'), miss('A random unrelated method', 'The recursive process should be purposeful.', 'Approach base case.')]),
  ...
  q(403043, 'Chapter 6: Arrays, ArrayLists, and 2D Data', 'Hash map', 'A hash map stores:', 'Key-value pairs', [miss('Only sorted numbers', 'Hash maps are keyed collections, not necessarily sorted.', 'Map keys to values.'), miss('Only recursive calls', 'Not a data structure role.', 'Associative lookup.'), miss('Only pixels', 'Not generally.', 'Key-value.')]),
  ...
  q(403049, 'Chapter 2: Algorithms and Computational Thinking', 'Chapter 2: Algorithms and Computational Thinking', 'Abstraction helps programmers by:', 'Hiding unnecessary detail behind simpler interfaces', [miss('Adding every detail everywhere', 'That is the opposite.', 'Hide complexity.'), miss('Preventing reuse', 'Abstraction supports reuse.', 'Use interface.'), miss('Making code impossible to reason about', 'Good abstraction improves reasoning.', 'Simplify mental model.')]),
