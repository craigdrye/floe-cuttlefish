...
export const ibCh3Questions: Question[] = [
  ...
  q(4351204, 'Career Skills', CHAPTER, 'Unlevering beta workflow',
    ...
    [
      ...
      ['Pick the comp closest in size to your target and use its levered beta unchanged', 'Single-comp betas are noisy and still carry that comp\'s specific capital structure. The averaging step exists to dampen single-name noise; the unlever-relever step exists to control for leverage differences.'],
  ...
  q(4351207, 'Career Skills', CHAPTER, 'Equity risk premium source discipline',
    ...
    [
      ...
      ['Skip the ERP and use the company\'s historical stock return as the cost of equity', 'A single company\'s historical return mixes operating performance, market beta, and luck. It is neither a market premium nor a forward-looking estimate.'],
    ],
  ...
  q(4351235, 'Career Skills', CHAPTER, 'Convertible note treatment in diluted count',
    ...
    [
      ...
      ['Ignore the convertibles in the diluted count because they are debt, not equity, until conversion', 'Convertibles in the money are included in diluted share count precisely because they can be converted to equity. Ignoring them understates dilution and overstates diluted EPS.'],
  ...
  q(4351236, 'Career Skills', CHAPTER, 'Minority interest in EV bridge',
    ...
    [
      ...
      ['Ignore minority interest because it is a balance sheet line, not an operating item', 'Minority interest is a real claim on the operating business. Ignoring it makes EV/EBITDA inconsistent — the multiple\'s denominator includes earnings that the numerator does not pay for.'],
  ...
  q(4351237, 'Career Skills', CHAPTER, 'Preferred stock in EV bridge',
    ...
    [
      ...
      ['Ignore preferred unless the dividend is cumulative and unpaid', 'Preferred is a real capital-structure claim regardless of whether dividends are cumulative or current. The bridge captures all senior claims on the operating business; whether dividends are accrued affects the size of the claim, not whether it is in the bridge at all.'],
