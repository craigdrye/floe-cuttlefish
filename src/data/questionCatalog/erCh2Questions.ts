...
export const erCh2Questions: Question[] = [
  ...
  q(4370105, 'Career Skills', CHAPTER, '8-K Item 1.01 material agreement',
    ...
    [
      ['Treat the exhibit as unusable because several pricing lines are redacted', 'Redacted agreements still disclose term, counterparty type, termination rights, and exclusivity clauses — all of which are analytically valuable. Only pricing and certain commercially sensitive details are typically redacted under confidential treatment requests.'],
      ['Conclude that the hidden terms must be unfavorable to the company', 'Redactions are usually requested to protect *competitive* terms, not to hide bad news. Inferring direction from the existence of redaction is speculation; the visible terms tell you more than the missing ones.'],
