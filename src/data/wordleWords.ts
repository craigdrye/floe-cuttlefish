// Curated 5-letter word list. Used both for solutions and for guess validation.
// Mix of common nouns, verbs, adjectives. Keep lowercase; UI uppercases.
...
export const wordleWords: string[] = [
  ...
  'brown', 'build', 'built', 'buyer', 'cable', 'carry', 'catch',
  'cause', 'chain', 'chair', 'chart', 'chase', 'cheap', 'check', 'chest',
  'chief', 'child', 'chose', 'civil', 'claim', 'class', 'clean',
  ...
  'guide', 'happy', 'heart', 'heavy', 'hence', 'horse',
  'hotel', 'house', 'human', 'ideal', 'image', 'index', 'inner', 'input',
  'issue', 'joint', 'judge', 'known', 'label',
  'large', 'laser', 'later', 'laugh', 'layer', 'learn', 'lease', 'least',
  'leave', 'legal', 'level', 'light', 'limit', 'links', 'lives',
  ...
  'silly', 'since', 'sixth', 'sixty', 'sized', 'skill', 'sleep', 'slide',
  ...
  'teach', 'teeth', 'thank', 'theft', 'their', 'theme',
  'there', 'these', 'thick', 'thing', 'think', 'third', 'those', 'three',
  'threw', 'throw', 'tiger', 'tight', 'times', 'tired', 'title', 'today',
...
export const wordleWordSet = new Set(wordleWords)
