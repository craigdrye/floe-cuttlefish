      ...
      <section className="fight-layout">
        ...
        <section className="fight-stage">
          <details className="game-rules" open>
            <summary><HelpCircle size={14} /> How to play Mr T Throwdown</summary>
            <div className="game-rules-body">
              <ol>
                ...
                <li><strong>Fire:</strong> <kbd>double-click</kbd> or <kbd>double-tap</kbd> to launch a dot at Mr T Floe.</li>
                <li>Mr T jumps, slides side to side, and fires back — even mid-air. Dodge his dots while landing your own.</li>
          ...
          <div className="fight-hud">
            ...
            <div className="fight-hud-side fight-hud-right">
              <span className="fight-hud-name">Mr T Floe</span>
              <div className="fight-hp">
                {Array.from({ length: MAX_HP }).map((_, i) => (
          ...
          >
            ...
            >
              <img src={OPPONENT_SRC} alt="Mr T Floe" />
            ...
            {status === 'won' && (
              <div className="fight-overlay fight-overlay-win">
                <h3>You knocked out Mr T Floe.</h3>
            ...
            {status === 'lost' && (
              <div className="fight-overlay fight-overlay-lose">
                <h3>Mr T Floe got the better of you.</h3>
                <p>Pity the fool. Try again.</p>
                <button type="button" onClick={startGame}>Rematch</button>
              </div>
            )}
          </div>
