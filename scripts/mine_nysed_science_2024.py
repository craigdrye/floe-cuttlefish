...
OUTPUT_DIR = REPO_ROOT / "data" / "raw_collections" / "nysed_science_2024"
OUTPUT_JSON = OUTPUT_DIR / "nysed_science_2024_questions.json"
OUTPUT_MD = OUTPUT_DIR / "nysed_science_2024_summary.md"
USER_AGENT = "floe-rebuild8-content-miner/1.0"

GRADE_URLS = {
    5: "https://www.nysedregents.org/ei/science/2024/2024-released-items-science-g5.pdf",
    8: "https://www.nysedregents.org/ei/science/2024/2024-released-items-science-g8.pdf",
}
...
def build_questions() -> list[ExtractedQuestion]:
    ...
    for grade, url in GRADE_URLS.items():
        ...
        exam_title = f"NYSED 2024 Grade {grade} Science"
        collection_id = f"nysed-science-2024::grade-{grade}"
        for question_number, prompt_text in sorted(questions.items()):
            items.append(
                ExtractedQuestion(
                    ...
                    topic_tags=[exam_title, "science", f"grade-{grade}", "nysed-2024"],
                )
            )
    return items
...
def write_outputs(items: list[ExtractedQuestion]) -> None:
    ...
    payload = {
        "source": "NYSED 2024 Grade 5 and Grade 8 Science Released Questions",
    ...
    lines = [
        "# NYSED Science 2024 Raw Collection",
        "",
        "- Source: NYSED 2024 Grade 5 and Grade 8 Science Released Questions",
...
def main() -> None:
    ...
    write_outputs(items)
    print(f"Extracted {len(items)} NYSED 2024 science questions into {OUTPUT_JSON}")
