...
OUTPUT_DIR = REPO_ROOT / "data" / "raw_collections" / "nysed_ela_2015"
OUTPUT_JSON = OUTPUT_DIR / "nysed_ela_2015_questions.json"
OUTPUT_MD = OUTPUT_DIR / "nysed_ela_2015_summary.md"
USER_AGENT = "floe-rebuild8-content-miner/1.0"

GRADE_URLS = {
    3: "https://www.nysedregents.org/ei/ela/2015/2015-released-items-ela-g3.pdf",
    4: "https://www.nysedregents.org/ei/ela/2015/2015-released-items-ela-g4.pdf",
    5: "https://www.nysedregents.org/ei/ela/2015/2015-released-items-ela-g5.pdf",
    6: "https://www.nysedregents.org/ei/ela/2015/2015-released-items-ela-g6.pdf",
    7: "https://www.nysedregents.org/ei/ela/2015/2015-released-items-ela-g7.pdf",
    8: "https://www.nysedregents.org/ei/ela/2015/2015-released-items-ela-g8.pdf",
}
...
def build_questions() -> list[ExtractedQuestion]:
    ...
    for grade, url in GRADE_URLS.items():
        ...
        exam_title = f"NYSED 2015 Grade {grade} ELA"
        collection_id = f"nysed-ela-2015::grade-{grade}"
        for question_number, prompt_text in sorted(questions.items()):
            items.append(
                ExtractedQuestion(
                    ...
                    topic_tags=[exam_title, "ela", f"grade-{grade}", "nysed-2015"],
                )
            )
    return items
...
def write_outputs(items: list[ExtractedQuestion]) -> None:
    ...
    payload = {
        "source": "NYSED 2015 Grades 3-8 English Language Arts Released Questions",
...
def main() -> None:
    ...
    write_outputs(items)
    print(f"Extracted {len(items)} NYSED 2015 ELA questions into {OUTPUT_JSON}")
