...
OUTPUT_DIR = REPO_ROOT / "data" / "raw_collections" / "nysed_math_2017"
OUTPUT_JSON = OUTPUT_DIR / "nysed_math_2017_questions.json"
OUTPUT_MD = OUTPUT_DIR / "nysed_math_2017_summary.md"
USER_AGENT = "floe-rebuild8-content-miner/1.0"

GRADE_URLS = {
    3: "https://www.nysedregents.org/ei/math/2017/english/2017-released-items-math-g3.pdf",
    4: "https://www.nysedregents.org/ei/math/2017/english/2017-released-items-math-g4.pdf",
    5: "https://www.nysedregents.org/ei/math/2017/english/2017-released-items-math-g5.pdf",
    6: "https://www.nysedregents.org/ei/math/2017/english/2017-released-items-math-g6.pdf",
    7: "https://www.nysedregents.org/ei/math/2017/english/2017-released-items-math-g7crp3.pdf",
    8: "https://www.nysedregents.org/ei/math/2017/english/2017-released-items-math-g8cr.pdf",
}
...
def build_questions() -> list[ExtractedQuestion]:
    ...
    for grade, url in GRADE_URLS.items():
        ...
        exam_title = f"NYSED 2017 Grade {grade} Math"
        collection_id = f"nysed-math-2017::grade-{grade}"
        for question_number, prompt_text in sorted(questions.items()):
            items.append(
                ExtractedQuestion(
                    ...
                    topic_tags=[exam_title, "math", f"grade-{grade}", "nysed-2017"],
                )
            )
    return items
...
def write_outputs(items: list[ExtractedQuestion]) -> None:
    ...
    payload = {
        "source": "NYSED 2017 Grades 3-8 Mathematics Released Questions",
    ...
    lines = [
        "# NYSED Math 2017 Raw Collection",
        "",
        "- Source: NYSED 2017 Grades 3-8 Mathematics Released Questions",
...
def main() -> None:
    ...
    write_outputs(items)
    print(f"Extracted {len(items)} NYSED 2017 math questions into {OUTPUT_JSON}")
